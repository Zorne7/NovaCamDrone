...
public class NumberProgressBar extends View {
    ...
    public NumberProgressBar(Context context, AttributeSet attributeSet, int i) {
        ...
        TypedArray typedArrayObtainStyledAttributes = context.getTheme().obtainStyledAttributes(attributeSet, C0492R.styleable.NumberProgressBar, i, 0);
        this.mReachedBarColor = typedArrayObtainStyledAttributes.getColor(C0492R.styleable.NumberProgressBar_progress_reached_color, iRgb2);
        this.mUnreachedBarColor = typedArrayObtainStyledAttributes.getColor(C0492R.styleable.NumberProgressBar_progress_unreached_color, iRgb3);
        this.mTextColor = typedArrayObtainStyledAttributes.getColor(C0492R.styleable.NumberProgressBar_progress_text_color, iRgb);
        this.mTextSize = typedArrayObtainStyledAttributes.getDimension(C0492R.styleable.NumberProgressBar_progress_text_size, fSp2px);
        this.mReachedBarHeight = typedArrayObtainStyledAttributes.getDimension(C0492R.styleable.NumberProgressBar_progress_reached_bar_height, fDp2px);
        this.mUnreachedBarHeight = typedArrayObtainStyledAttributes.getDimension(C0492R.styleable.NumberProgressBar_progress_unreached_bar_height, fDp2px2);
        this.mOffset = typedArrayObtainStyledAttributes.getDimension(C0492R.styleable.NumberProgressBar_progress_text_offset, fDp2px3);
        if (typedArrayObtainStyledAttributes.getInt(C0492R.styleable.NumberProgressBar_progress_text_visibility, 0) != 0) {
            this.mIfDrawText = false;
        }
        setProgress(typedArrayObtainStyledAttributes.getInt(C0492R.styleable.NumberProgressBar_progress_current, 0));
        setMax(typedArrayObtainStyledAttributes.getInt(C0492R.styleable.NumberProgressBar_progress_max, 100));
