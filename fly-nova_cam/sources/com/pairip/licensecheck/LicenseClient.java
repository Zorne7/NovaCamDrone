...
public class LicenseClient implements ServiceConnection {
    ...
    protected static String licensePubKey = "";
    protected static boolean localCheckEnabled = false;
    protected static ImmediateTaskExecutor mainThreadRunner = null;
    protected static String packageName = "com.yls.nova";
    ...
    private void retryOrThrow(LicenseCheckException error, boolean ignoreErrorOnFinalFailure) {
        ...
        if (i < 3) {
            ...
            Log.d(TAG, String.format("Retry #%d. License check failed with error '%s'. Next try in %ds...", Integer.valueOf(this.retryNum), error == null ? ImageLoader.DEFAULT_PATH : error.getMessage(), 1L));
        } else {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void processResponse(int responseCode, Bundle responsePayload2) throws LicenseCheckException {
        try {
            if (responseCode == 3) {
