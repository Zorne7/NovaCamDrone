...
public final class AnimatorSet extends Animator {
    ...
    @Override // com.nineoldandroids.animation.Animator
    /* renamed from: clone */
    public AnimatorSet mo529clone() {
        AnimatorSet animatorSet = (AnimatorSet) super.mo529clone();
        ...
        while (it.hasNext()) {
            Node next = it.next();
            Node nodeM530clone = next.m530clone();
            map.put(next, nodeM530clone);
            animatorSet.mNodes.add(nodeM530clone);
            animatorSet.mNodeMap.put(nodeM530clone.animation, nodeM530clone);
            ArrayList arrayList = null;
            nodeM530clone.dependencies = null;
            nodeM530clone.tmpDependencies = null;
            nodeM530clone.nodeDependents = null;
            nodeM530clone.nodeDependencies = null;
            ArrayList<Animator.AnimatorListener> listeners = nodeM530clone.animation.getListeners();
            if (listeners != null) {
    ...
    private static class Node implements Cloneable {
        ...
        public Node m530clone() {
            try {
                Node node = (Node) super.clone();
                node.animation = this.animation.mo529clone();
                return node;
