...
public class ValueAnimator extends Animator {
    ...
    @Override // com.nineoldandroids.animation.Animator
    /* renamed from: clone */
    public ValueAnimator mo529clone() {
        ValueAnimator valueAnimator = (ValueAnimator) super.mo529clone();
        ArrayList<AnimatorUpdateListener> arrayList = this.mUpdateListeners;
        if (arrayList != null) {
        ...
        if (propertyValuesHolderArr != null) {
            ...
            for (int i2 = 0; i2 < length; i2++) {
                PropertyValuesHolder propertyValuesHolderMo533clone = propertyValuesHolderArr[i2].mo533clone();
                valueAnimator.mValues[i2] = propertyValuesHolderMo533clone;
                valueAnimator.mValuesMap.put(propertyValuesHolderMo533clone.getPropertyName(), propertyValuesHolderMo533clone);
            }
        }
        return valueAnimator;
    }
