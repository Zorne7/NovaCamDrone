...
public class PropertyValuesHolder implements Cloneable {
    ...
    @Override // 
    /* renamed from: clone */
    public PropertyValuesHolder mo533clone() {
        try {
            PropertyValuesHolder propertyValuesHolder = (PropertyValuesHolder) super.clone();
            propertyValuesHolder.mPropertyName = this.mPropertyName;
            propertyValuesHolder.mProperty = this.mProperty;
            propertyValuesHolder.mKeyframeSet = this.mKeyframeSet.mo531clone();
    ...
    static class IntPropertyValuesHolder extends PropertyValuesHolder {
        ...
        @Override // com.nineoldandroids.animation.PropertyValuesHolder
        /* renamed from: clone */
        public IntPropertyValuesHolder mo533clone() {
            IntPropertyValuesHolder intPropertyValuesHolder = (IntPropertyValuesHolder) super.mo533clone();
    ...
    static class FloatPropertyValuesHolder extends PropertyValuesHolder {
        ...
        public FloatPropertyValuesHolder mo533clone() {
            FloatPropertyValuesHolder floatPropertyValuesHolder = (FloatPropertyValuesHolder) super.mo533clone();
