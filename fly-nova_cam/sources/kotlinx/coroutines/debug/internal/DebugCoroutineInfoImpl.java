...
public final class DebugCoroutineInfoImpl {
    ...
    @DebugMetadata(m430c = "kotlinx.coroutines.debug.internal.DebugCoroutineInfoImpl", m431f = "DebugCoroutineInfoImpl.kt", m432i = {}, m433l = {80}, m434m = "yieldFrames", m435n = {}, m436s = {})
    ...
    static final class C07971 extends ContinuationImpl {
        ...
        C07971(Continuation<? super C07971> continuation) {
            super(continuation);
        }
    ...
    private final List<StackTraceElement> creationStackTrace() {
        ...
        return stackTraceFrame == null ? CollectionsKt.emptyList() : SequencesKt.toList(SequencesKt.sequence(new C07961(stackTraceFrame, null)));
    }

    /* compiled from: DebugCoroutineInfoImpl.kt */
    @Metadata(m421d1 = {"\u0000\u000e\n\u0000\n\u0002\u0010\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\u0010\u0000\u001a\u00020\u0001*\b\u0012\u0004\u0012\u00020\u00030\u0002H\u008a@"}, m422d2 = {"<anonymous>", "", "Lkotlin/sequences/SequenceScope;", "Ljava/lang/StackTraceElement;"}, m423k = 3, m424mv = {1, 6, 0}, m426xi = 48)
    @DebugMetadata(m430c = "kotlinx.coroutines.debug.internal.DebugCoroutineInfoImpl$creationStackTrace$1", m431f = "DebugCoroutineInfoImpl.kt", m432i = {}, m433l = {75}, m434m = "invokeSuspend", m435n = {}, m436s = {})
    /* renamed from: kotlinx.coroutines.debug.internal.DebugCoroutineInfoImpl$creationStackTrace$1 */
    static final class C07961 extends RestrictedSuspendLambda implements Function2<SequenceScope<? super StackTraceElement>, Continuation<? super Unit>, Object> {
        final /* synthetic */ StackTraceFrame $bottom;
        private /* synthetic */ Object L$0;
        int label;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C07961(StackTraceFrame stackTraceFrame, Continuation<? super C07961> continuation) {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C07961 c07961 = DebugCoroutineInfoImpl.this.new C07961(this.$bottom, continuation);
            c07961.L$0 = obj;
            return c07961;
        }
        ...
        public final Object invoke(SequenceScope<? super StackTraceElement> sequenceScope, Continuation<? super Unit> continuation) {
            return ((C07961) create(sequenceScope, continuation)).invokeSuspend(Unit.INSTANCE);
        }
    ...
    /* JADX WARN: Unsupported multi-entry loop pattern (BACK_EDGE: B:19:0x004b -> B:26:0x0063). Please report as a decompilation issue!!! */
    ...
    */
    public final Object yieldFrames(SequenceScope<? super StackTraceElement> sequenceScope, CoroutineStackFrame coroutineStackFrame, Continuation<? super Unit> continuation) throws Throwable {
        ...
        if (continuation instanceof C07971) {
            c07971 = (C07971) continuation;
            if ((c07971.label & Integer.MIN_VALUE) != 0) {
                c07971.label -= Integer.MIN_VALUE;
            } else {
                c07971 = new C07971(continuation);
            }
        }
        Object obj = c07971.result;
        Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
        int i = c07971.label;
        if (i == 0) {
            ResultKt.throwOnFailure(obj);
            ...
            CoroutineStackFrame coroutineStackFrame2 = (CoroutineStackFrame) c07971.L$2;
            SequenceScope<? super StackTraceElement> sequenceScope2 = (SequenceScope) c07971.L$1;
            debugCoroutineInfoImpl = (DebugCoroutineInfoImpl) c07971.L$0;
            ResultKt.throwOnFailure(obj);
            ...
            if (coroutineStackFrame == null) {
                ...
                if (stackTraceElement != null) {
                    c07971.L$0 = debugCoroutineInfoImpl;
                    c07971.L$1 = sequenceScope;
                    c07971.L$2 = coroutineStackFrame;
                    c07971.label = 1;
                    if (sequenceScope.yield(stackTraceElement, c07971) == coroutine_suspended) {
                        return coroutine_suspended;
                    }
