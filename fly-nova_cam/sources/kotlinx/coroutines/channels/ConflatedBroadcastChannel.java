...
public final class ConflatedBroadcastChannel<E> implements BroadcastChannel<E> {
    ...
    /* compiled from: ConflatedBroadcastChannel.kt */
    @Metadata(m421d1 = {"\u0000\u0012\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\n\u0002\u0010\u0003\n\u0002\b\u0007\b\u0002\u0018\u00002\u00020\u0001B\u000f\u0012\b\u0010\u0002\u001a\u0004\u0018\u00010\u0003¢\u0006\u0002\u0010\u0004R\u0012\u0010\u0002\u001a\u0004\u0018\u00010\u00038\u0006X\u0087\u0004¢\u0006\u0002\n\u0000R\u0011\u0010\u0005\u001a\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\u0006\u0010\u0007R\u0011\u0010\b\u001a\u00020\u00038F¢\u0006\u0006\u001a\u0004\b\t\u0010\u0007¨\u0006\n"}, m422d2 = {"Lkotlinx/coroutines/channels/ConflatedBroadcastChannel$Closed;", "", "closeCause", "", "(Ljava/lang/Throwable;)V", "sendException", "getSendException", "()Ljava/lang/Throwable;", "valueException", "getValueException", "kotlinx-coroutines-core"}, m423k = 1, m424mv = {1, 6, 0}, m426xi = 48)
    ...
    public ReceiveChannel<E> openSubscription() {
        ...
        } while (!C0141xc40028dd.m78m(_state$FU, this, obj, new State(state.value, addSubscriber(state.subscribers, subscriber))));
        return subscriber;
    }
    ...
    public void invokeOnClose(Function1<? super Throwable, Unit> handler) {
        ...
        if ((obj2 instanceof Closed) && C0141xc40028dd.m78m(atomicReferenceFieldUpdater, this, handler, AbstractChannelKt.HANDLER_INVOKED)) {
    ...
    public Object mo2046trySendJP2dKIU(E element) {
        Closed closedOfferInternal = offerInternal(element);
        if (closedOfferInternal != null) {
            return ChannelResult.INSTANCE.m2064closedJP2dKIU(closedOfferInternal.getSendException());
        }
    ...
    private final Closed offerInternal(E element) {
        ...
        } while (!C0141xc40028dd.m78m(_state$FU, this, obj, new State(element, ((State) obj).subscribers)));
    ...
    public final void closeSubscriber(Subscriber<E> subscriber) {
        ...
        } while (!C0141xc40028dd.m78m(_state$FU, this, obj, new State(obj2, removeSubscriber(subscriberArr, subscriber))));
    }
    ...
    public boolean cancel(Throwable cause) {
        ...
        } while (!C0141xc40028dd.m78m(_state$FU, this, obj, cause == null ? CLOSED : new Closed(cause)));
        Subscriber<E>[] subscriberArr = ((State) obj).subscribers;
        if (subscriberArr != null) {
            int length = subscriberArr.length;
            while (i < length) {
