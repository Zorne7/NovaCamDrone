...
public class ChannelCoroutine<E> extends AbstractCoroutine<Unit> implements Channel<E> {
    ...
    public Object mo2044receiveCatchingJP2dKIU(Continuation<? super ChannelResult<? extends E>> continuation) {
        Object obj = this._channel.mo2044receiveCatchingJP2dKIU(continuation);
    ...
    public Object mo2045tryReceivePtdJZtk() {
        return this._channel.mo2045tryReceivePtdJZtk();
    }

    @Override // kotlinx.coroutines.channels.SendChannel
    /* renamed from: trySend-JP2dKIU */
    public Object mo2046trySendJP2dKIU(E element) {
        return this._channel.mo2046trySendJP2dKIU(element);
    }
