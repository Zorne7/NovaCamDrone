...
public interface ReceiveChannel<E> {
    ...
    Object mo2044receiveCatchingJP2dKIU(Continuation<? super ChannelResult<? extends E>> continuation);

    @Deprecated(level = DeprecationLevel.ERROR, message = "Deprecated in favor of 'receiveCatching'. Please note that the provided replacement does not rethrow channel's close cause as 'receiveOrNull' did, for the detailed replacement please refer to the 'receiveOrNull' documentation", replaceWith = @ReplaceWith(expression = "receiveCatching().getOrNull()", imports = {}))
    Object receiveOrNull(Continuation<? super E> continuation);

    /* renamed from: tryReceive-PtdJZtk */
    Object mo2045tryReceivePtdJZtk();
    ...
    public static final class DefaultImpls {
        ...
        public static <E> E poll(ReceiveChannel<? extends E> receiveChannel) throws Throwable {
            Object objMo2045tryReceivePtdJZtk = receiveChannel.mo2045tryReceivePtdJZtk();
            if (ChannelResult.m2061isSuccessimpl(objMo2045tryReceivePtdJZtk)) {
                return (E) ChannelResult.m2057getOrThrowimpl(objMo2045tryReceivePtdJZtk);
            }
            Throwable thM2055exceptionOrNullimpl = ChannelResult.m2055exceptionOrNullimpl(objMo2045tryReceivePtdJZtk);
            if (thM2055exceptionOrNullimpl == null) {
                return null;
            }
            throw StackTraceRecoveryKt.recoverStackTrace(thM2055exceptionOrNullimpl);
        }
        ...
        */
        public static <E> Object receiveOrNull(ReceiveChannel<? extends E> receiveChannel, Continuation<? super E> continuation) throws Throwable {
            ...
            if (i == 0) {
                ...
                c07921.label = 1;
                objMo2044receiveCatchingJP2dKIU = receiveChannel.mo2044receiveCatchingJP2dKIU(c07921);
            ...
            return ChannelResult.m2056getOrNullimpl(objMo2044receiveCatchingJP2dKIU);
        }
