...
public interface SendChannel<E> {
    ...
    Object mo2046trySendJP2dKIU(E element);
    ...
    public static final class DefaultImpls {
        ...
        public static <E> boolean offer(SendChannel<? super E> sendChannel, E e) throws Throwable {
            ...
            if (ChannelResult.m2061isSuccessimpl(objMo2046trySendJP2dKIU)) {
                return true;
            }
            Throwable thM2055exceptionOrNullimpl = ChannelResult.m2055exceptionOrNullimpl(objMo2046trySendJP2dKIU);
