...
public final class TimeoutKt {
    ...
    public static final <T> Object m2039withTimeoutKLykuaI(long j, Function2<? super CoroutineScope, ? super Continuation<? super T>, ? extends Object> function2, Continuation<? super T> continuation) {
        return withTimeout(DelayKt.m2031toDelayMillisLRDsOJo(j), function2, continuation);
    }
    ...
    */
    public static final <T> Object withTimeoutOrNull(long j, Function2<? super CoroutineScope, ? super Continuation<? super T>, ? extends Object> function2, Continuation<? super T> continuation) throws Throwable {
        ...
        if (continuation instanceof C07411) {
            c07411 = (C07411) continuation;
            if ((c07411.label & Integer.MIN_VALUE) != 0) {
                c07411.label -= Integer.MIN_VALUE;
            } else {
                c07411 = new C07411(continuation);
            }
        }
        Object obj = c07411.result;
        ...
        if (i == 0) {
            ...
            try {
                c07411.L$0 = function2;
                c07411.L$1 = objectRef2;
                c07411.J$0 = j;
                c07411.label = 1;
                ?? r4 = (T) new TimeoutCoroutine(j, c07411);
                objectRef2.element = r4;
                Object obj2 = setupTimeout(r4, function2);
                if (obj2 == IntrinsicsKt.getCOROUTINE_SUSPENDED()) {
                    DebugProbesKt.probeCoroutineSuspended(c07411);
                }
            ...
            long j2 = c07411.J$0;
            objectRef = (Ref.ObjectRef) c07411.L$1;
            try {
                ResultKt.throwOnFailure(obj);
                return obj;
    ...
    public static final <T> Object m2040withTimeoutOrNullKLykuaI(long j, Function2<? super CoroutineScope, ? super Continuation<? super T>, ? extends Object> function2, Continuation<? super T> continuation) {
        return withTimeoutOrNull(DelayKt.m2031toDelayMillisLRDsOJo(j), function2, continuation);
    }
