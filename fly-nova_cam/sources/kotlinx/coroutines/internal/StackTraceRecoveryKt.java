...
public final class StackTraceRecoveryKt {
    ...
    static {
        ...
        try {
            ...
            objM558constructorimpl = Result.m558constructorimpl(Class.forName(baseContinuationImplClass).getCanonicalName());
        } catch (Throwable th) {
        ...
        if (Result.m561exceptionOrNullimpl(objM558constructorimpl) == null) {
            obj2 = objM558constructorimpl;
        }
        baseContinuationImplClassName = (String) obj2;
        try {
            Result.Companion companion3 = Result.INSTANCE;
            objM558constructorimpl2 = Result.m558constructorimpl(Class.forName(stackTraceRecoveryClass).getCanonicalName());
        } catch (Throwable th2) {
            Result.Companion companion4 = Result.INSTANCE;
            objM558constructorimpl2 = Result.m558constructorimpl(ResultKt.createFailure(th2));
        }
        if (Result.m561exceptionOrNullimpl(objM558constructorimpl2) == null) {
            obj = objM558constructorimpl2;
        }
        ...
        if (cause != null && Intrinsics.areEqual(cause.getClass(), e.getClass())) {
            ...
            while (i < length) {
                ...
                if (isArtificial(stackTraceElement)) {
                    return TuplesKt.m429to(cause, stackTrace);
                }
            }
            return TuplesKt.m429to(e, new StackTraceElement[0]);
        }
        return TuplesKt.m429to(e, new StackTraceElement[0]);
    }
