...
public final class DispatchedContinuation<T> extends DispatchedTask<T> implements CoroutineStackFrame, Continuation<T> {
    ...
    public void resumeWith(Object result) {
        ...
        if (this.dispatcher.isDispatchNeeded(context)) {
            ...
            this.resumeMode = 0;
            this.dispatcher.mo2092dispatch(context, this);
            return;
        }
    ...
    */
    public final void resumeCancellableWith(Object result, Function1<? super Throwable, Unit> onCancellation) {
        ...
        if (this.dispatcher.isDispatchNeeded(get$context())) {
            this._state = state;
            this.resumeMode = 1;
            this.dispatcher.mo2092dispatch(get$context(), this);
            return;
        }
        DebugKt.getASSERTIONS_ENABLED();
        EventLoop eventLoop$kotlinx_coroutines_core = ThreadLocalEventLoop.INSTANCE.getEventLoop$kotlinx_coroutines_core();
        ...
        eventLoop$kotlinx_coroutines_core.incrementUseCount(true);
        try {
            job = (Job) get$context().get(Job.INSTANCE);
        } catch (Throwable th) {
            try {
        ...
        if (job != null && !job.isActive()) {
            ...
            resumeWith(Result.m558constructorimpl(ResultKt.createFailure(cancellationException)));
        } else {
            Continuation<T> continuation = this.continuation;
    ...
    */
    ...
    public final CancellableContinuationImpl<T> claimReusableCancellableContinuation() {
        while (true) {
            ...
            if (obj instanceof CancellableContinuationImpl) {
                if (C0141xc40028dd.m78m(_reusableCancellableContinuation$FU, this, obj, DispatchedContinuationKt.REUSABLE_CLAIMED)) {
                    return (CancellableContinuationImpl) obj;
                }
    ...
    public final Throwable tryReleaseClaimedContinuation(CancellableContinuation<?> continuation) {
        do {
            ...
            if (obj != DispatchedContinuationKt.REUSABLE_CLAIMED) {
                if (obj instanceof Throwable) {
                    if (!C0141xc40028dd.m78m(_reusableCancellableContinuation$FU, this, obj, null)) {
        ...
        } while (!C0141xc40028dd.m78m(_reusableCancellableContinuation$FU, this, DispatchedContinuationKt.REUSABLE_CLAIMED, continuation));
        return null;
    }
    ...
    public final boolean postponeCancellation(Throwable cause) {
        while (true) {
            ...
            if (Intrinsics.areEqual(obj, DispatchedContinuationKt.REUSABLE_CLAIMED)) {
                if (C0141xc40028dd.m78m(_reusableCancellableContinuation$FU, this, DispatchedContinuationKt.REUSABLE_CLAIMED, cause)) {
                    return true;
                }
            } else {
                if (obj instanceof Throwable) {
