...
public class CancellableContinuationImpl<T> extends DispatchedTask<T> implements CancellableContinuation<T>, CoroutineStackFrame {
    ...
    public void invokeOnCancellation(Function1<? super Throwable, Unit> handler) {
        ...
        while (true) {
            ...
            if (obj instanceof Active) {
                if (C0141xc40028dd.m78m(_state$FU, this, obj, cancelHandlerMakeCancelHandler)) {
                    return;
                }
                ...
                if (obj instanceof CompletedContinuation) {
                    ...
                    if (completedContinuation.getCancelled()) {
                        ...
                        if (C0141xc40028dd.m78m(_state$FU, this, obj, CompletedContinuation.copy$default(completedContinuation, null, cancelHandlerMakeCancelHandler, null, null, null, 29, null))) {
                            return;
                        }
                    }
                } else {
                    ...
                    if (C0141xc40028dd.m78m(_state$FU, this, obj, new CompletedContinuation(obj, cancelHandlerMakeCancelHandler, null, null, null, 28, null))) {
                        return;
                    }
                }
            }
    ...
    public void cancelCompletedResult$kotlinx_coroutines_core(Object takenState, Throwable cause) {
        while (true) {
            ...
            if (obj instanceof CompletedContinuation) {
                ...
                if (C0141xc40028dd.m78m(_state$FU, this, obj, CompletedContinuation.copy$default(completedContinuation, null, null, null, null, cause, 15, null))) {
                    completedContinuation.invokeHandlers(this, cause);
                    return;
                }
            } else if (C0141xc40028dd.m78m(_state$FU, this, obj, new CompletedContinuation(obj, null, null, null, cause, 14, null))) {
                return;
            }
        }
    }
    ...
    public boolean cancel(Throwable cause) {
        ...
        } while (!C0141xc40028dd.m78m(_state$FU, this, obj, new CancelledContinuation(this, cause, z)));
    ...
    private final void resumeImpl(Object proposedUpdate, int resumeMode, Function1<? super Throwable, Unit> onCancellation) {
        ...
        } while (!C0141xc40028dd.m78m(_state$FU, this, obj, resumedState((NotCompleted) obj, proposedUpdate, resumeMode, onCancellation, null)));
        detachChildIfNonResuable();
    ...
    private final Symbol tryResumeImpl(Object proposedUpdate, Object idempotent, Function1<? super Throwable, Unit> onCancellation) {
        ...
        } while (!C0141xc40028dd.m78m(_state$FU, this, obj, resumedState((NotCompleted) obj, proposedUpdate, this.resumeMode, onCancellation, idempotent)));
        detachChildIfNonResuable();
        return CancellableContinuationImplKt.RESUME_TOKEN;
    }
}
