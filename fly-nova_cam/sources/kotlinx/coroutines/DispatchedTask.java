...
public abstract class DispatchedTask<T> extends Task {
    ...
    */
    public final void run() {
        ...
        Object objM558constructorimpl2;
        ...
        try {
            ...
            try {
                ...
                if (job != null && !job.isActive()) {
                    ...
                    continuation.resumeWith(Result.m558constructorimpl(ResultKt.createFailure(cancellationExceptionRecoverFromStackFrame)));
                } else if (exceptionalResult$kotlinx_coroutines_core != null) {
                    Result.Companion companion2 = Result.INSTANCE;
                    continuation.resumeWith(Result.m558constructorimpl(ResultKt.createFailure(exceptionalResult$kotlinx_coroutines_core)));
                } else {
                    ...
                    continuation.resumeWith(Result.m558constructorimpl(successfulResult$kotlinx_coroutines_core));
                }
                ...
                try {
                    ...
                    objM558constructorimpl2 = Result.m558constructorimpl(Unit.INSTANCE);
                } catch (Throwable th) {
                    Result.Companion companion5 = Result.INSTANCE;
                    objM558constructorimpl2 = Result.m558constructorimpl(ResultKt.createFailure(th));
                }
                handleFatalException(null, Result.m561exceptionOrNullimpl(objM558constructorimpl2));
            } finally {
            ...
            try {
                ...
                objM558constructorimpl = Result.m558constructorimpl(ResultKt.createFailure(th3));
            }
            handleFatalException(th2, Result.m561exceptionOrNullimpl(objM558constructorimpl));
        }
    }
