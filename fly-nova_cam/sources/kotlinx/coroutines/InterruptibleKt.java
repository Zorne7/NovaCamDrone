...
public final class InterruptibleKt {
    ...
    /* compiled from: Interruptible.kt */
    @Metadata(m421d1 = {"\u0000\b\n\u0002\b\u0002\n\u0002\u0018\u0002\u0010\u0000\u001a\u0002H\u0001\"\u0004\b\u0000\u0010\u0001*\u00020\u0002H\u008a@"}, m422d2 = {"<anonymous>", "T", "Lkotlinx/coroutines/CoroutineScope;"}, m423k = 3, m424mv = {1, 6, 0}, m426xi = 48)
    @DebugMetadata(m430c = "kotlinx.coroutines.InterruptibleKt$runInterruptible$2", m431f = "Interruptible.kt", m432i = {}, m433l = {}, m434m = "invokeSuspend", m435n = {}, m436s = {})
    /* renamed from: kotlinx.coroutines.InterruptibleKt$runInterruptible$2 */
    static final class C07392<T> extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super T>, Object> {
        ...
        C07392(Function0<? extends T> function0, Continuation<? super C07392> continuation) {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C07392 c07392 = new C07392(this.$block, continuation);
            c07392.L$0 = obj;
            return c07392;
        }
        ...
        public final Object invoke(CoroutineScope coroutineScope, Continuation<? super T> continuation) {
            return ((C07392) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
        }
    ...
    public static final <T> Object runInterruptible(CoroutineContext coroutineContext, Function0<? extends T> function0, Continuation<? super T> continuation) {
        return BuildersKt.withContext(coroutineContext, new C07392(function0, null), continuation);
    }
