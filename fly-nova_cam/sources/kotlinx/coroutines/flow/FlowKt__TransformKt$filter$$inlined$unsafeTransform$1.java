...
public final class FlowKt__TransformKt$filter$$inlined$unsafeTransform$1<T> implements Flow<T> {
    ...
    public static final class C08782<T> implements FlowCollector, SuspendFunction {
        final /* synthetic */ Function2 $predicate$inlined;
        final /* synthetic */ FlowCollector $this_unsafeFlow;

        /* compiled from: Emitters.kt */
        @Metadata(m423k = 3, m424mv = {1, 6, 0}, m426xi = 176)
        @DebugMetadata(m430c = "kotlinx.coroutines.flow.FlowKt__TransformKt$filter$$inlined$unsafeTransform$1$2", m431f = "Transform.kt", m432i = {0, 0}, m433l = {223, 223}, m434m = "emit", m435n = {"value", "$this$filter_u24lambda_u2d0"}, m436s = {"L$0", "L$1"})
        ...
        public static final class AnonymousClass1 extends ContinuationImpl {
            ...
            public final Object invokeSuspend(Object obj) {
                ...
                return C08782.this.emit(null, this);
            }
        }

        public C08782(FlowCollector flowCollector, Function2 function2) {
    ...
    public Object collect(FlowCollector flowCollector, Continuation continuation) {
        Object objCollect = this.$this_unsafeTransform$inlined.collect(new C08782(flowCollector, this.$predicate$inlined), continuation);
    ...
    public Object collect$$forInline(FlowCollector flowCollector, Continuation continuation) {
        ...
        C08782 c08782 = new C08782(flowCollector, this.$predicate$inlined);
        InlineMarker.mark(0);
        flow.collect(c08782, continuation);
        InlineMarker.mark(1);
        return Unit.INSTANCE;
    }
}
