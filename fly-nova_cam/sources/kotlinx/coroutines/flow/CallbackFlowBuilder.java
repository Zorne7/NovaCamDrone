...
final class CallbackFlowBuilder<T> extends ChannelFlowBuilder<T> {
    ...
    @DebugMetadata(m430c = "kotlinx.coroutines.flow.CallbackFlowBuilder", m431f = "Builders.kt", m432i = {0}, m433l = {336}, m434m = "collectTo", m435n = {"scope"}, m436s = {"L$0"})
    ...
    static final class C08041 extends ContinuationImpl {
        ...
        C08041(CallbackFlowBuilder<T> callbackFlowBuilder, Continuation<? super C08041> continuation) {
            super(continuation);
    ...
    */
    protected Object collectTo(ProducerScope<? super T> producerScope, Continuation<? super Unit> continuation) throws Throwable {
        ...
        if (i == 0) {
            ...
            c08041.L$0 = producerScope;
            c08041.label = 1;
            if (super.collectTo(producerScope, c08041) == coroutine_suspended) {
            ...
            producerScope = (ProducerScope) c08041.L$0;
            ResultKt.throwOnFailure(obj);
        }
