...
final /* synthetic */ class FlowKt__ErrorsKt {
    ...
    /* compiled from: Errors.kt */
    @Metadata(m421d1 = {"\u0000\u000e\n\u0000\n\u0002\u0010\u000b\n\u0002\b\u0002\n\u0002\u0010\u0003\u0010\u0000\u001a\u00020\u0001\"\u0004\b\u0000\u0010\u00022\u0006\u0010\u0003\u001a\u00020\u0004H\u008a@"}, m422d2 = {"<anonymous>", "", "T", "it", ""}, m423k = 3, m424mv = {1, 6, 0}, m426xi = 48)
    @DebugMetadata(m430c = "kotlinx.coroutines.flow.FlowKt__ErrorsKt$retry$1", m431f = "Errors.kt", m432i = {}, m433l = {}, m434m = "invokeSuspend", m435n = {}, m436s = {})
    /* renamed from: kotlinx.coroutines.flow.FlowKt__ErrorsKt$retry$1 */
    static final class C08411 extends SuspendLambda implements Function2<Throwable, Continuation<? super Boolean>, Object> {
        int label;
        ...
        public final Object invoke(Throwable th, Continuation<? super Boolean> continuation) {
            return ((C08411) create(th, continuation)).invokeSuspend(Unit.INSTANCE);
        }
    ...
    /* compiled from: Errors.kt */
    @Metadata(m421d1 = {"\u0000\u0018\n\u0000\n\u0002\u0010\u000b\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0003\n\u0000\n\u0002\u0010\t\u0010\u0000\u001a\u00020\u0001\"\u0004\b\u0000\u0010\u0002*\b\u0012\u0004\u0012\u0002H\u00020\u00032\u0006\u0010\u0004\u001a\u00020\u00052\u0006\u0010\u0006\u001a\u00020\u0007H\u008a@"}, m422d2 = {"<anonymous>", "", "T", "Lkotlinx/coroutines/flow/FlowCollector;", "cause", "", "attempt", ""}, m423k = 3, m424mv = {1, 6, 0}, m426xi = 48)
    @DebugMetadata(m430c = "kotlinx.coroutines.flow.FlowKt__ErrorsKt$retry$3", m431f = "Errors.kt", m432i = {}, m433l = {95}, m434m = "invokeSuspend", m435n = {}, m436s = {})
    /* renamed from: kotlinx.coroutines.flow.FlowKt__ErrorsKt$retry$3 */
    static final class C08423<T> extends SuspendLambda implements Function4<FlowCollector<? super T>, Throwable, Long, Continuation<? super Boolean>, Object> {
        ...
        C08423(long j, Function2<? super Throwable, ? super Continuation<? super Boolean>, ? extends Object> function2, Continuation<? super C08423> continuation) {
        ...
        public final Object invoke(FlowCollector<? super T> flowCollector, Throwable th, long j, Continuation<? super Boolean> continuation) {
            C08423 c08423 = new C08423(this.$retries, this.$predicate, continuation);
            c08423.L$0 = th;
            c08423.J$0 = j;
            return c08423.invokeSuspend(Unit.INSTANCE);
        }
    ...
    public static final <T> Flow<T> retry(Flow<? extends T> flow, long j, Function2<? super Throwable, ? super Continuation<? super Boolean>, ? extends Object> function2) {
        ...
        return FlowKt.retryWhen(flow, new C08423(j, function2, null));
    }
    ...
    */
    public static final <T> Object catchImpl(Flow<? extends T> flow, FlowCollector<? super T> flowCollector, Continuation<? super Throwable> continuation) throws Throwable {
        ...
        if (continuation instanceof C08391) {
            c08391 = (C08391) continuation;
            if ((c08391.label & Integer.MIN_VALUE) != 0) {
                c08391.label -= Integer.MIN_VALUE;
            } else {
                c08391 = new C08391(continuation);
            }
        }
        Object obj = c08391.result;
        Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
        int i = c08391.label;
        if (i == 0) {
            ResultKt.throwOnFailure(obj);
            ...
            try {
                FlowCollector<? super Object> c08402 = new C08402<>(flowCollector, objectRef2);
                c08391.L$0 = objectRef2;
                c08391.label = 1;
                if (flow.collect(c08402, c08391) == coroutine_suspended) {
                    return coroutine_suspended;
                }
                return null;
            } catch (Throwable th) {
            ...
            objectRef = (Ref.ObjectRef) c08391.L$0;
            try {
                ResultKt.throwOnFailure(obj);
                return null;
            } catch (Throwable th2) {
        ...
        if (isSameExceptionAs$FlowKt__ErrorsKt(th, th3) || isCancellationCause$FlowKt__ErrorsKt(th, c08391.getContext())) {
            throw th;
        }
        if (th3 == null) {
            return th;
    ...
    static final class C08402<T> implements FlowCollector, SuspendFunction {
        final /* synthetic */ FlowCollector<T> $collector;
        final /* synthetic */ Ref.ObjectRef<Throwable> $fromDownstream;

        /* JADX WARN: Multi-variable type inference failed */
        C08402(FlowCollector<? super T> flowCollector, Ref.ObjectRef<Throwable> objectRef) {
        ...
        */
        public final Object emit(T t, Continuation<? super Unit> continuation) throws Throwable {
            ...
            if (i != 0) {
                if (i == 1) {
                    c08402 = (C08402) flowKt__ErrorsKt$catchImpl$2$emit$1.L$0;
                    try {
                        ResultKt.throwOnFailure(obj);
                    ...
                    L19:
                        ...
                        kotlinx.coroutines.flow.FlowKt__ErrorsKt$catchImpl$2 r5 = (kotlinx.coroutines.flow.FlowKt__ErrorsKt.C08402) r5
                    ...
                    L4d:
                        ...
                        throw r6
                    */
                    throw new UnsupportedOperationException("Method not decompiled: kotlinx.coroutines.flow.FlowKt__ErrorsKt.C08402.emit(java.lang.Object, kotlin.coroutines.Continuation):java.lang.Object");
                }
            }
            ...
            public static final <T> Flow<T> m2077catch(Flow<? extends T> flow, Function3<? super FlowCollector<? super T>, ? super Throwable, ? super Continuation<? super Unit>, ? extends Object> function3) {
