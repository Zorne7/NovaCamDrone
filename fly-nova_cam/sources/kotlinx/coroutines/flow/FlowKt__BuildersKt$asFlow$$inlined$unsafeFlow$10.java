...
public final class FlowKt__BuildersKt$asFlow$$inlined$unsafeFlow$10 implements Flow<Long> {
    ...
    @DebugMetadata(m430c = "kotlinx.coroutines.flow.FlowKt__BuildersKt$asFlow$$inlined$unsafeFlow$10", m431f = "Builders.kt", m432i = {0}, m433l = {115}, m434m = "collect", m435n = {"$this$asFlow_u24lambda_u2d19"}, m436s = {"L$0"})
    /* renamed from: kotlinx.coroutines.flow.FlowKt__BuildersKt$asFlow$$inlined$unsafeFlow$10$1 */
    public static final class C08071 extends ContinuationImpl {
        Object L$0;
        Object L$1;
        int label;
    ...
    */
    public Object collect(FlowCollector<? super Long> flowCollector, Continuation<? super Unit> continuation) throws Throwable {
        ...
        if (i == 0) {
            ...
            it = (Iterator) c08071.L$1;
            FlowCollector flowCollector3 = (FlowCollector) c08071.L$0;
            ResultKt.throwOnFailure(obj);
            flowCollector2 = flowCollector3;
        }
        while (it.hasNext()) {
            Long lBoxLong = Boxing.boxLong(((LongIterator) it).nextLong());
            c08071.L$0 = flowCollector2;
            c08071.L$1 = it;
            c08071.label = 1;
            if (flowCollector2.emit(lBoxLong, c08071) == coroutine_suspended) {
