...
public final class C0846xdf1aa1b6<T> implements FlowCollector<T> {
    ...
    @DebugMetadata(m430c = "kotlinx.coroutines.flow.FlowKt__LimitKt$transformWhile$1$invokeSuspend$$inlined$collectWhile$1", m431f = "Limit.kt", m432i = {0}, m433l = {143}, m434m = "emit", m435n = {"this"}, m436s = {"L$0"})
    ...
    public static final class AnonymousClass1 extends ContinuationImpl {
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            return C0846xdf1aa1b6.this.emit(null, this);
        }
    }

    public C0846xdf1aa1b6(Function3 function3, FlowCollector flowCollector) {
    ...
    */
    public Object emit(T t, Continuation<? super Unit> continuation) throws Throwable {
        ...
        C0846xdf1aa1b6<T> c0846xdf1aa1b6;
        ...
        if (i == 0) {
            ...
            c0846xdf1aa1b6 = (C0846xdf1aa1b6) anonymousClass1.L$0;
            ResultKt.throwOnFailure(objInvoke);
        }
        if (((Boolean) objInvoke).booleanValue()) {
            return Unit.INSTANCE;
        }
        throw new AbortFlowException(c0846xdf1aa1b6);
    }
}
