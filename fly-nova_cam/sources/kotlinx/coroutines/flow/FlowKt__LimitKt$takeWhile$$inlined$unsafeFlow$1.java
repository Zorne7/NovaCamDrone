...
public final class FlowKt__LimitKt$takeWhile$$inlined$unsafeFlow$1<T> implements Flow<T> {
    ...
    @DebugMetadata(m430c = "kotlinx.coroutines.flow.FlowKt__LimitKt$takeWhile$$inlined$unsafeFlow$1", m431f = "Limit.kt", m432i = {0}, m433l = {124}, m434m = "collect", m435n = {"collector$iv"}, m436s = {"L$0"})
    ...
    */
    public Object collect(FlowCollector<? super T> flowCollector, Continuation<? super Unit> continuation) throws Throwable {
        ...
        if (i == 0) {
            ...
            try {
                c08441.L$0 = flowKt__LimitKt$takeWhile$lambda6$$inlined$collectWhile$12;
                c08441.label = 1;
                if (flow.collect(flowKt__LimitKt$takeWhile$lambda6$$inlined$collectWhile$12, c08441) == coroutine_suspended) {
            ...
            flowKt__LimitKt$takeWhile$lambda6$$inlined$collectWhile$1 = (FlowKt__LimitKt$takeWhile$lambda6$$inlined$collectWhile$1) c08441.L$0;
            try {
                ResultKt.throwOnFailure(obj);
