...
public final class FlowKt__ReduceKt$firstOrNull$$inlined$collectWhile$2<T> implements FlowCollector<T> {
    ...
    @DebugMetadata(m430c = "kotlinx.coroutines.flow.FlowKt__ReduceKt$firstOrNull$$inlined$collectWhile$2", m431f = "Reduce.kt", m432i = {0, 0}, m433l = {143}, m434m = "emit", m435n = {"this", "it"}, m436s = {"L$0", "L$1"})
    /* renamed from: kotlinx.coroutines.flow.FlowKt__ReduceKt$firstOrNull$$inlined$collectWhile$2$1 */
    public static final class C08581 extends ContinuationImpl {
        Object L$0;
        Object L$1;
        int label;
        /* synthetic */ Object result;

        public C08581(Continuation continuation) {
            super(continuation);
        }
    ...
    */
    public Object emit(T t, Continuation<? super Unit> continuation) throws Throwable {
        ...
        Object objInvoke = c08581.result;
        ...
        if (i == 0) {
            ...
            c08581.label = 1;
            InlineMarker.mark(6);
            objInvoke = function2.invoke(t, c08581);
            InlineMarker.mark(7);
            ...
            t = (T) c08581.L$1;
            flowKt__ReduceKt$firstOrNull$$inlined$collectWhile$2 = (FlowKt__ReduceKt$firstOrNull$$inlined$collectWhile$2) c08581.L$0;
            ResultKt.throwOnFailure(objInvoke);
        }
