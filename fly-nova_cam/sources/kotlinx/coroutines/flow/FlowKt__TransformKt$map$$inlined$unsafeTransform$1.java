...
public final class FlowKt__TransformKt$map$$inlined$unsafeTransform$1<R> implements Flow<R> {
    ...
    public static final class C08852<T> implements FlowCollector, SuspendFunction {
        final /* synthetic */ FlowCollector $this_unsafeFlow;
        final /* synthetic */ Function2 $transform$inlined;

        /* compiled from: Emitters.kt */
        @Metadata(m423k = 3, m424mv = {1, 6, 0}, m426xi = 176)
        @DebugMetadata(m430c = "kotlinx.coroutines.flow.FlowKt__TransformKt$map$$inlined$unsafeTransform$1$2", m431f = "Transform.kt", m432i = {}, m433l = {223, 223}, m434m = "emit", m435n = {}, m436s = {})
        ...
        public static final class AnonymousClass1 extends ContinuationImpl {
            ...
            public final Object invokeSuspend(Object obj) {
                ...
                return C08852.this.emit(null, this);
            }
        }

        public C08852(FlowCollector flowCollector, Function2 function2) {
    ...
    public Object collect(FlowCollector flowCollector, Continuation continuation) {
        Object objCollect = this.$this_unsafeTransform$inlined.collect(new C08852(flowCollector, this.$transform$inlined$1), continuation);
    ...
    public Object collect$$forInline(FlowCollector flowCollector, Continuation continuation) {
        ...
        C08852 c08852 = new C08852(flowCollector, this.$transform$inlined$1);
        InlineMarker.mark(0);
        flow.collect(c08852, continuation);
        InlineMarker.mark(1);
        return Unit.INSTANCE;
    }
}
