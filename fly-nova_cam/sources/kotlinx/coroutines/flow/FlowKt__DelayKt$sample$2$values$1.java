...
@DebugMetadata(m430c = "kotlinx.coroutines.flow.FlowKt__DelayKt$sample$2$values$1", m431f = "Delay.kt", m432i = {}, m433l = {280}, m434m = "invokeSuspend", m435n = {}, m436s = {})
...
final class FlowKt__DelayKt$sample$2$values$1 extends SuspendLambda implements Function2<ProducerScope<? super Object>, Continuation<? super Unit>, Object> {
    ...
    static final class C08311<T> implements FlowCollector, SuspendFunction {
        final /* synthetic */ ProducerScope<Object> $$this$produce;

        C08311(ProducerScope<Object> producerScope) {
    ...
    public final Object invokeSuspend(Object obj) throws Throwable {
        ...
        if (i == 0) {
            ...
            this.label = 1;
            if (this.$this_sample.collect(new C08311(producerScope), this) == coroutine_suspended) {
                return coroutine_suspended;
            }
        } else {
            if (i != 1) {
