...
public final class FlowKt__BuildersKt$asFlow$$inlined$unsafeFlow$8 implements Flow<Long> {
    ...
    @DebugMetadata(m430c = "kotlinx.coroutines.flow.FlowKt__BuildersKt$asFlow$$inlined$unsafeFlow$8", m431f = "Builders.kt", m432i = {0}, m433l = {115}, m434m = "collect", m435n = {"$this$asFlow_u24lambda_u2d15"}, m436s = {"L$0"})
    /* renamed from: kotlinx.coroutines.flow.FlowKt__BuildersKt$asFlow$$inlined$unsafeFlow$8$1 */
    public static final class C08141 extends ContinuationImpl {
        int I$0;
        int I$1;
        Object L$0;
        Object L$1;
        ...
        public C08141(Continuation continuation) {
            super(continuation);
        }
    ...
    */
    public Object collect(FlowCollector<? super Long> flowCollector, Continuation<? super Unit> continuation) throws Throwable {
        ...
        if (i3 == 0) {
            ...
            i2 = c08141.I$1;
            int i4 = c08141.I$0;
            long[] jArr3 = (long[]) c08141.L$1;
            FlowCollector flowCollector3 = (FlowCollector) c08141.L$0;
            ResultKt.throwOnFailure(obj);
        ...
        while (i < i2) {
            ...
            c08141.L$0 = flowCollector2;
            c08141.L$1 = jArr4;
            c08141.I$0 = i;
            c08141.I$1 = i2;
            c08141.label = 1;
            if (flowCollector2.emit(lBoxLong, c08141) == coroutine_suspended) {
