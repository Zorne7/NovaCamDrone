...
public final class SubscribedFlowCollector<T> implements FlowCollector<T> {
    ...
    @DebugMetadata(m430c = "kotlinx.coroutines.flow.SubscribedFlowCollector", m431f = "Share.kt", m432i = {0, 0}, m433l = {419, 423}, m434m = "onSubscription", m435n = {"this", "safeCollector"}, m436s = {"L$0", "L$1"})
    ...
    static final class C09101 extends ContinuationImpl {
        ...
        C09101(SubscribedFlowCollector<T> subscribedFlowCollector, Continuation<? super C09101> continuation) {
            super(continuation);
    ...
    public final Object onSubscription(Continuation<? super Unit> continuation) throws Throwable {
        ...
        if (continuation instanceof C09101) {
            ...
            if ((c09101.label & Integer.MIN_VALUE) != 0) {
                ...
                c09101 = new C09101(this, continuation);
            }
        }
        ...
        try {
            if (r2 == 0) {
                ...
                safeCollector = new SafeCollector(this.collector, c09101.getContext());
                Function2<FlowCollector<? super T>, Continuation<? super Unit>, Object> function2 = this.action;
                c09101.L$0 = this;
                c09101.L$1 = safeCollector;
                c09101.label = 1;
                if (function2.invoke(safeCollector, c09101) == coroutine_suspended) {
                ...
                safeCollector = (SafeCollector) c09101.L$1;
                subscribedFlowCollector = (SubscribedFlowCollector) c09101.L$0;
                ResultKt.throwOnFailure(obj);
            }
            ...
            c09101.L$1 = null;
            c09101.label = 2;
            if (((SubscribedFlowCollector) flowCollector).onSubscription(c09101) == coroutine_suspended) {
                return coroutine_suspended;
            }
            return Unit.INSTANCE;
        } catch (Throwable th) {
