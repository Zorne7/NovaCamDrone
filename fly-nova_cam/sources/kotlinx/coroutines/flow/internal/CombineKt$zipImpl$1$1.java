...
@Metadata(m421d1 = {"\u0000\u000e\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\u0010\u0000\u001a\u00020\u0001\"\u0004\b\u0000\u0010\u0002\"\u0004\b\u0001\u0010\u0003\"\u0004\b\u0002\u0010\u0004*\u00020\u0005H\u008a@"}, m422d2 = {"<anonymous>", "", "T1", "T2", "R", "Lkotlinx/coroutines/CoroutineScope;"}, m423k = 3, m424mv = {1, 6, 0}, m426xi = 48)
@DebugMetadata(m430c = "kotlinx.coroutines.flow.internal.CombineKt$zipImpl$1$1", m431f = "Combine.kt", m432i = {0}, m433l = {129}, m434m = "invokeSuspend", m435n = {"second"}, m436s = {"L$0"})
...
final class CombineKt$zipImpl$1$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public final Object invokeSuspend(Object obj) throws Throwable {
        ...
        try {
            ...
            if (ChannelFlowKt.withContextUndispatched$default(coroutineScope.getCoroutineContext().plus(completableJobJob$default), Unit.INSTANCE, null, new C09182(this.$flow, coroutineContext, objThreadContextElements, receiveChannelProduce$default, this.$this_unsafeFlow, this.$transform, null), this, 4, null) == coroutine_suspended) {
    ...
    /* compiled from: Combine.kt */
    @Metadata(m421d1 = {"\u0000\n\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0004\u0010\u0000\u001a\u00020\u0001\"\u0004\b\u0000\u0010\u0002\"\u0004\b\u0001\u0010\u0003\"\u0004\b\u0002\u0010\u00042\u0006\u0010\u0005\u001a\u00020\u0001H\u008a@"}, m422d2 = {"<anonymous>", "", "T1", "T2", "R", "it"}, m423k = 3, m424mv = {1, 6, 0}, m426xi = 48)
    @DebugMetadata(m430c = "kotlinx.coroutines.flow.internal.CombineKt$zipImpl$1$1$2", m431f = "Combine.kt", m432i = {}, m433l = {130}, m434m = "invokeSuspend", m435n = {}, m436s = {})
    /* renamed from: kotlinx.coroutines.flow.internal.CombineKt$zipImpl$1$1$2 */
    static final class C09182 extends SuspendLambda implements Function2<Unit, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        /* JADX WARN: Multi-variable type inference failed */
        C09182(Flow<? extends T1> flow, CoroutineContext coroutineContext, Object obj, ReceiveChannel<? extends Object> receiveChannel, FlowCollector<? super R> flowCollector, Function3<? super T1, ? super T2, ? super Continuation<? super R>, ? extends Object> function3, Continuation<? super C09182> continuation) {
            super(2, continuation);
            this.$flow = flow;
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return new C09182(this.$flow, this.$scopeContext, this.$cnt, this.$second, this.$this_unsafeFlow, this.$transform, continuation);
        }

        @Override // kotlin.jvm.functions.Function2
        public final Object invoke(Unit unit, Continuation<? super Unit> continuation) {
            return ((C09182) create(unit, continuation)).invokeSuspend(Unit.INSTANCE);
        }

        /* compiled from: Combine.kt */
        @Metadata(m421d1 = {"\u0000\n\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0006\u0010\u0000\u001a\u00020\u0001\"\u0004\b\u0000\u0010\u0002\"\u0004\b\u0001\u0010\u0003\"\u0004\b\u0002\u0010\u00042\u0006\u0010\u0005\u001a\u0002H\u0002H\u008a@¢\u0006\u0004\b\u0006\u0010\u0007"}, m422d2 = {"<anonymous>", "", "T1", "T2", "R", "value", "emit", "(Ljava/lang/Object;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;"}, m423k = 3, m424mv = {1, 6, 0}, m426xi = 48)
        ...
        static final class AnonymousClass1<T> implements FlowCollector, SuspendFunction {
            ...
            /* compiled from: Combine.kt */
            @Metadata(m421d1 = {"\u0000\n\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0004\u0010\u0000\u001a\u00020\u0001\"\u0004\b\u0000\u0010\u0002\"\u0004\b\u0001\u0010\u0003\"\u0004\b\u0002\u0010\u00042\u0006\u0010\u0005\u001a\u00020\u0001H\u008a@"}, m422d2 = {"<anonymous>", "", "T1", "T2", "R", "it"}, m423k = 3, m424mv = {1, 6, 0}, m426xi = 48)
            @DebugMetadata(m430c = "kotlinx.coroutines.flow.internal.CombineKt$zipImpl$1$1$2$1$1", m431f = "Combine.kt", m432i = {}, m433l = {132, 135, 135}, m434m = "invokeSuspend", m435n = {}, m436s = {})
            /* renamed from: kotlinx.coroutines.flow.internal.CombineKt$zipImpl$1$1$2$1$1, reason: invalid class name and collision with other inner class name */
            static final class C09951 extends SuspendLambda implements Function2<Unit, Continuation<? super Unit>, Object> {
                final /* synthetic */ ReceiveChannel<Object> $second;
                final /* synthetic */ FlowCollector<R> $this_unsafeFlow;
                final /* synthetic */ Function3<T1, T2, Continuation<? super R>, Object> $transform;
                ...
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                /* JADX WARN: Multi-variable type inference failed */
                C09951(ReceiveChannel<? extends Object> receiveChannel, FlowCollector<? super R> flowCollector, Function3<? super T1, ? super T2, ? super Continuation<? super R>, ? extends Object> function3, T1 t1, Continuation<? super C09951> continuation) {
                    super(2, continuation);
                    this.$second = receiveChannel;
                    this.$this_unsafeFlow = flowCollector;
                    this.$transform = function3;
                ...
                @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
                public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
                    return new C09951(this.$second, this.$this_unsafeFlow, this.$transform, this.$value, continuation);
                }

                @Override // kotlin.jvm.functions.Function2
                public final Object invoke(Unit unit, Continuation<? super Unit> continuation) {
                    return ((C09951) create(unit, continuation)).invokeSuspend(Unit.INSTANCE);
                }
                ...
                */
                public final Object invokeSuspend(Object obj) throws Throwable {
                    Object objMo2044receiveCatchingJP2dKIU;
                    ...
                    if (i == 0) {
                        ResultKt.throwOnFailure(obj);
                        this.label = 1;
                        objMo2044receiveCatchingJP2dKIU = this.$second.mo2044receiveCatchingJP2dKIU(this);
                        if (objMo2044receiveCatchingJP2dKIU == coroutine_suspended) {
                            return coroutine_suspended;
                        }
                    } else {
                        if (i != 1) {
                        ...
                        ResultKt.throwOnFailure(obj);
                        objMo2044receiveCatchingJP2dKIU = ((ChannelResult) obj).getHolder();
                    }
                    FlowCollector flowCollector3 = this.$this_unsafeFlow;
                    if (objMo2044receiveCatchingJP2dKIU instanceof ChannelResult.Failed) {
                        Throwable thM2055exceptionOrNullimpl = ChannelResult.m2055exceptionOrNullimpl(objMo2044receiveCatchingJP2dKIU);
                        if (thM2055exceptionOrNullimpl == null) {
                            throw new AbortFlowException(flowCollector3);
                        }
                        throw thM2055exceptionOrNullimpl;
                    }
                    Function3<T1, T2, Continuation<? super R>, Object> function3 = this.$transform;
                    T1 t1 = this.$value;
                    if (objMo2044receiveCatchingJP2dKIU == NullSurrogateKt.NULL) {
                        objMo2044receiveCatchingJP2dKIU = null;
                    }
                    this.L$0 = flowCollector3;
                    this.label = 2;
                    obj = function3.invoke(t1, objMo2044receiveCatchingJP2dKIU, this);
            ...
            */
            public final Object emit(T1 t1, Continuation<? super Unit> continuation) throws Throwable {
                ...
                if (i == 0) {
                    ...
                    C09951 c09951 = new C09951(this.$second, this.$this_unsafeFlow, this.$transform, t1, null);
                    combineKt$zipImpl$1$1$2$1$emit$1.label = 1;
                    if (ChannelFlowKt.withContextUndispatched(coroutineContext, unit, obj2, c09951, combineKt$zipImpl$1$1$2$1$emit$1) == coroutine_suspended) {
                        return coroutine_suspended;
                    }
                } else {
                    if (i != 1) {
