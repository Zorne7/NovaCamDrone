...
public abstract class ChannelFlow<T> implements FusibleFlow<T> {
  ...
  0x0023: PHI (r4v9 int) = (r4v2 int), (r4v2 int), (r4v7 int) binds: [B:15:0x0021, B:20:0x0029, B:36:0x004f] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    */
    ...
    @DebugMetadata(m430c = "kotlinx.coroutines.flow.internal.ChannelFlow$collect$2", m431f = "ChannelFlow.kt", m432i = {}, m433l = {123}, m434m = "invokeSuspend", m435n = {}, m436s = {})
    ...
    static final class C09122 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        C09122(FlowCollector<? super T> flowCollector, ChannelFlow<T> channelFlow, Continuation<? super C09122> continuation) {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C09122 c09122 = new C09122(this.$collector, this.this$0, continuation);
            c09122.L$0 = obj;
            return c09122;
        }
    ...
    static /* synthetic */ Object collect$suspendImpl(ChannelFlow channelFlow, FlowCollector flowCollector, Continuation continuation) {
        Object objCoroutineScope = CoroutineScopeKt.coroutineScope(new C09122(flowCollector, channelFlow, null), continuation);
