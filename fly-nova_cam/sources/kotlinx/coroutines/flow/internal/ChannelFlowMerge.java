...
public final class ChannelFlowMerge<T> extends ChannelFlow<T> {
    ...
    protected Object collectTo(ProducerScope<? super T> producerScope, Continuation<? super Unit> continuation) {
        Object objCollect = this.flow.collect(new C09132((Job) continuation.getContext().get(Job.INSTANCE), SemaphoreKt.Semaphore$default(this.concurrency, 0, 2, null), producerScope, new SendingCollector(producerScope)), continuation);
        return objCollect == IntrinsicsKt.getCOROUTINE_SUSPENDED() ? objCollect : Unit.INSTANCE;
    }

    /* compiled from: Merge.kt */
    @Metadata(m421d1 = {"\u0000\u0012\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\u0010\u0000\u001a\u00020\u0001\"\u0004\b\u0000\u0010\u00022\f\u0010\u0003\u001a\b\u0012\u0004\u0012\u0002H\u00020\u0004H\u008a@¢\u0006\u0004\b\u0005\u0010\u0006"}, m422d2 = {"<anonymous>", "", "T", "inner", "Lkotlinx/coroutines/flow/Flow;", "emit", "(Lkotlinx/coroutines/flow/Flow;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;"}, m423k = 3, m424mv = {1, 6, 0}, m426xi = 48)
    /* renamed from: kotlinx.coroutines.flow.internal.ChannelFlowMerge$collectTo$2 */
    static final class C09132<T> implements FlowCollector, SuspendFunction {
        ...
        /* JADX WARN: Multi-variable type inference failed */
        C09132(Job job, Semaphore semaphore, ProducerScope<? super T> producerScope, SendingCollector<T> sendingCollector) {
            this.$job = job;
        ...
        */
        public final Object emit(Flow<? extends T> flow, Continuation<? super Unit> continuation) throws Throwable {
            ...
            if (i == 0) {
                ...
                c09132 = (C09132) channelFlowMerge$collectTo$2$emit$1.L$0;
                ResultKt.throwOnFailure(obj);
            }
            BuildersKt__Builders_commonKt.launch$default(c09132.$scope, null, null, new AnonymousClass1(flow, c09132.$collector, c09132.$semaphore, null), 3, null);
            return Unit.INSTANCE;
        }

        /* compiled from: Merge.kt */
        @Metadata(m421d1 = {"\u0000\f\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\u0010\u0000\u001a\u00020\u0001\"\u0004\b\u0000\u0010\u0002*\u00020\u0003H\u008a@"}, m422d2 = {"<anonymous>", "", "T", "Lkotlinx/coroutines/CoroutineScope;"}, m423k = 3, m424mv = {1, 6, 0}, m426xi = 48)
        @DebugMetadata(m430c = "kotlinx.coroutines.flow.internal.ChannelFlowMerge$collectTo$2$1", m431f = "Merge.kt", m432i = {}, m433l = {69}, m434m = "invokeSuspend", m435n = {}, m436s = {})
