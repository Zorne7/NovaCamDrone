...
public final class FlowKt__BuildersKt$asFlow$$inlined$unsafeFlow$5<T> implements Flow<T> {
    ...
    @DebugMetadata(m430c = "kotlinx.coroutines.flow.FlowKt__BuildersKt$asFlow$$inlined$unsafeFlow$5", m431f = "Builders.kt", m432i = {0}, m433l = {115}, m434m = "collect", m435n = {"$this$asFlow_u24lambda_u2d7"}, m436s = {"L$0"})
    /* renamed from: kotlinx.coroutines.flow.FlowKt__BuildersKt$asFlow$$inlined$unsafeFlow$5$1 */
    public static final class C08111 extends ContinuationImpl {
        Object L$0;
        Object L$1;
        int label;
    ...
    */
    public Object collect(FlowCollector<? super T> flowCollector, Continuation<? super Unit> continuation) throws Throwable {
        ...
        if (i == 0) {
            ...
            it = (Iterator) c08111.L$1;
            FlowCollector flowCollector3 = (FlowCollector) c08111.L$0;
            ResultKt.throwOnFailure(obj);
            flowCollector2 = flowCollector3;
        }
        while (it.hasNext()) {
            T next = it.next();
            c08111.L$0 = flowCollector2;
            c08111.L$1 = it;
            c08111.label = 1;
            if (flowCollector2.emit(next, c08111) == coroutine_suspended) {
