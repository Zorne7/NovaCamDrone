...
public final class FlowKt__TransformKt$runningFold$$inlined$unsafeFlow$1<R> implements Flow<R> {
    ...
    @DebugMetadata(m430c = "kotlinx.coroutines.flow.FlowKt__TransformKt$runningFold$$inlined$unsafeFlow$1", m431f = "Transform.kt", m432i = {0, 0, 0}, m433l = {114, 115}, m434m = "collect", m435n = {"this", "$this$runningFold_u24lambda_u2d8", "accumulator"}, m436s = {"L$0", "L$1", "L$2"})
    /* renamed from: kotlinx.coroutines.flow.FlowKt__TransformKt$runningFold$$inlined$unsafeFlow$1$1 */
    public static final class C08891 extends ContinuationImpl {
        Object L$0;
        Object L$1;
        Object L$2;
        int label;
    ...
    */
    public Object collect(FlowCollector<? super R> flowCollector, Continuation<? super Unit> continuation) throws Throwable {
        ...
        if (i == 0) {
            ...
            c08891.L$0 = this;
            c08891.L$1 = flowCollector;
            c08891.L$2 = objectRef2;
            c08891.label = 1;
            if (flowCollector.emit(t, c08891) == coroutine_suspended) {
            ...
            objectRef = (Ref.ObjectRef) c08891.L$2;
            flowCollector2 = (FlowCollector) c08891.L$1;
            flowKt__TransformKt$runningFold$$inlined$unsafeFlow$1 = (FlowKt__TransformKt$runningFold$$inlined$unsafeFlow$1) c08891.L$0;
            ResultKt.throwOnFailure(obj);
        }
        ...
        c08891.L$2 = null;
        c08891.label = 2;
        if (flow.collect(flowKt__TransformKt$runningFold$1$1, c08891) == coroutine_suspended) {
            return coroutine_suspended;
        }
        return Unit.INSTANCE;
    }
