...
@DebugMetadata(m430c = "kotlinx.coroutines.flow.FlowKt__ShareKt$launchSharingDeferred$1", m431f = "Share.kt", m432i = {}, m433l = {340}, m434m = "invokeSuspend", m435n = {}, m436s = {})
...
final class FlowKt__ShareKt$launchSharingDeferred$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public final Object invokeSuspend(Object obj) throws Throwable {
        ...
        try {
            if (i == 0) {
                ...
                this.label = 1;
                if (this.$upstream.collect(new C08761(objectRef, coroutineScope, this.$result), this) == coroutine_suspended) {
    ...
    static final class C08761<T> implements FlowCollector, SuspendFunction {
        final /* synthetic */ CoroutineScope $$this$launch;
        final /* synthetic */ CompletableDeferred<StateFlow<T>> $result;
        final /* synthetic */ Ref.ObjectRef<MutableStateFlow<T>> $state;

        C08761(Ref.ObjectRef<MutableStateFlow<T>> objectRef, CoroutineScope coroutineScope, CompletableDeferred<StateFlow<T>> completableDeferred) {
