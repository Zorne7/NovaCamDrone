...
final class SubscribedSharedFlow<T> implements SharedFlow<T> {
    ...
    @DebugMetadata(m430c = "kotlinx.coroutines.flow.SubscribedSharedFlow", m431f = "Share.kt", m432i = {}, m433l = {409}, m434m = "collect", m435n = {}, m436s = {})
    ...
    static final class C09111 extends ContinuationImpl {
        ...
        C09111(SubscribedSharedFlow<T> subscribedSharedFlow, Continuation<? super C09111> continuation) {
            super(continuation);
    ...
    public Object collect(FlowCollector<? super T> flowCollector, Continuation<?> continuation) throws Throwable {
        ...
        if (continuation instanceof C09111) {
            ...
            if ((c09111.label & Integer.MIN_VALUE) != 0) {
                ...
                c09111 = new C09111(this, continuation);
            }
        }
        ...
        if (i == 0) {
            ...
            c09111.label = 1;
            if (sharedFlow.collect(subscribedFlowCollector, c09111) == coroutine_suspended) {
