...
public class MediaPlayerProxy implements IMediaPlayer {
    ...
    public void sendRtcpRrData(byte[] bArr) throws IllegalStateException {
        this.mBackEndMediaPlayer.sendRtcpRrData(bArr);
    }
    ...
    public void takePicture(String str, String str2, int i, int i2, int i3) throws IllegalStateException, IOException, SecurityException, IllegalArgumentException {
        this.mBackEndMediaPlayer.takePicture(str, str2, i, i2, i3);
    }
    ...
    @Override // tv.danmaku.ijk.media.player.IMediaPlayer
    public void setOnReceivedRtcpSrDataListener(final IMediaPlayer.OnReceivedRtcpSrDataListener onReceivedRtcpSrDataListener) {
        if (onReceivedRtcpSrDataListener != null) {
            this.mBackEndMediaPlayer.setOnReceivedRtcpSrDataListener(new IMediaPlayer.OnReceivedRtcpSrDataListener() { // from class: tv.danmaku.ijk.media.player.MediaPlayerProxy.9
                ...
                public void onReceivedRtcpSrData(IMediaPlayer iMediaPlayer, byte[] bArr) {
                    onReceivedRtcpSrDataListener.onReceivedRtcpSrData(MediaPlayerProxy.this, bArr);
                }
            });
        } else {
            this.mBackEndMediaPlayer.setOnReceivedRtcpSrDataListener(null);
        }
    }

    @Override // tv.danmaku.ijk.media.player.IMediaPlayer
    public void setOnTookPictureListener(final IMediaPlayer.OnTookPictureListener onTookPictureListener) {
        if (onTookPictureListener != null) {
            this.mBackEndMediaPlayer.setOnTookPictureListener(new IMediaPlayer.OnTookPictureListener() { // from class: tv.danmaku.ijk.media.player.MediaPlayerProxy.10
                ...
                public void onTookPicture(IMediaPlayer iMediaPlayer, int i, String str) {
                    onTookPictureListener.onTookPicture(MediaPlayerProxy.this, i, str);
                }
            });
        } else {
            this.mBackEndMediaPlayer.setOnTookPictureListener(null);
        }
    }

    @Override // tv.danmaku.ijk.media.player.IMediaPlayer
    public void setOnRecordVideoListener(final IMediaPlayer.OnRecordVideoListener onRecordVideoListener) {
        if (onRecordVideoListener != null) {
            this.mBackEndMediaPlayer.setOnRecordVideoListener(new IMediaPlayer.OnRecordVideoListener() { // from class: tv.danmaku.ijk.media.player.MediaPlayerProxy.11
                ...
                public void onRecordVideo(IMediaPlayer iMediaPlayer, int i, String str) {
                    onRecordVideoListener.onRecordVideo(MediaPlayerProxy.this, i, str);
                }
            });
        } else {
            this.mBackEndMediaPlayer.setOnRecordVideoListener(null);
        }
    }

    @Override // tv.danmaku.ijk.media.player.IMediaPlayer
    public void setOnInsertVideoListener(final IMediaPlayer.OnInsertVideoListener onInsertVideoListener) {
        if (onInsertVideoListener != null) {
            this.mBackEndMediaPlayer.setOnInsertVideoListener(new IMediaPlayer.OnInsertVideoListener() { // from class: tv.danmaku.ijk.media.player.MediaPlayerProxy.12
                ...
                public void onInsertVideo(IMediaPlayer iMediaPlayer, int i) {
                    onInsertVideoListener.onInsertVideo(MediaPlayerProxy.this, i);
                }
            });
        } else {
            this.mBackEndMediaPlayer.setOnInsertVideoListener(null);
        }
    }

    @Override // tv.danmaku.ijk.media.player.IMediaPlayer
    public void setOnReceivedFrameListener(final IMediaPlayer.OnReceivedFrameListener onReceivedFrameListener) {
        if (onReceivedFrameListener != null) {
            this.mBackEndMediaPlayer.setOnReceivedFrameListener(new IMediaPlayer.OnReceivedFrameListener() { // from class: tv.danmaku.ijk.media.player.MediaPlayerProxy.13
                ...
                public void onReceivedFrame(IMediaPlayer iMediaPlayer, byte[] bArr, int i, int i2, int i3) {
                    onReceivedFrameListener.onReceivedFrame(MediaPlayerProxy.this, bArr, i, i2, i3);
                }
            });
        } else {
            this.mBackEndMediaPlayer.setOnReceivedFrameListener(null);
        }
    }

    @Override // tv.danmaku.ijk.media.player.IMediaPlayer
    public void setOnReceivedOriginalDataListener(final IMediaPlayer.OnReceivedOriginalDataListener onReceivedOriginalDataListener) {
        if (onReceivedOriginalDataListener != null) {
            this.mBackEndMediaPlayer.setOnReceivedOriginalDataListener(new IMediaPlayer.OnReceivedOriginalDataListener() { // from class: tv.danmaku.ijk.media.player.MediaPlayerProxy.14
                ...
                public void onReceivedOriginalData(IMediaPlayer iMediaPlayer, byte[] bArr, int i, int i2, int i3, int i4) {
                    onReceivedOriginalDataListener.onReceivedOriginalData(MediaPlayerProxy.this, bArr, i, i2, i3, i4);
                }
            });
        } else {
            this.mBackEndMediaPlayer.setOnReceivedOriginalDataListener(null);
        }
    }

    @Override // tv.danmaku.ijk.media.player.IMediaPlayer
    public void setOnDeviceConnectedListener(final IMediaPlayer.OnDeviceConnectedListener onDeviceConnectedListener) {
        if (onDeviceConnectedListener != null) {
            this.mBackEndMediaPlayer.setOnDeviceConnectedListener(new IMediaPlayer.OnDeviceConnectedListener() { // from class: tv.danmaku.ijk.media.player.MediaPlayerProxy.15
                ...
                public void onDeviceConnected(IMediaPlayer iMediaPlayer) {
                    onDeviceConnectedListener.onDeviceConnected(MediaPlayerProxy.this);
                }
            });
        } else {
            this.mBackEndMediaPlayer.setOnDeviceConnectedListener(null);
        }
    }
