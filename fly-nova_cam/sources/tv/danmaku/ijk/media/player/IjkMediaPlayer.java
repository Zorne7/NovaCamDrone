...
public final class IjkMediaPlayer extends AbstractMediaPlayer {
    ...
    protected static final int INS_VIDEO_STATE = 80021;
    ...
    protected static final int ORG_VIDEO_STATE = 80029;
    protected static final int OUT_VIDEO_STATE = 80028;
    public static final int PROP_FLOAT_VIDEO_DECODE_FRAMES_PER_SECOND = 10001;
    public static final int PROP_FLOAT_VIDEO_DEFINE_FRAMES_PER_SECOND = 10101;
    public static final int PROP_FLOAT_VIDEO_FORCE_FRAMERATE = 10102;
    ...
    protected static final int TAKE_PIC_STATE = 80010;
    ...
    private native void _dropRecordFrame(int i) throws IllegalStateException;
    ...
    private native float _getScale() throws IllegalStateException;

    private native String _getVideoCodecInfo();

    private native void _injectCacheNode(int i, long j, long j2, long j3, long j4);

    private native void _insertVideoData(byte[] bArr, int i, int i2, boolean z) throws IllegalStateException;

    private native void _pause() throws IllegalStateException;

    private native void _prestartInsertVideo(String str, String str2, int i, int i2) throws IllegalStateException, IOException, SecurityException, IllegalArgumentException;

    private native void _release();

    private native void _reset();

    private native void _sendRtcpRrData(byte[] bArr, int i) throws IllegalStateException;
    ...
    private native void _setOutputOriginalVideo(boolean z) throws IllegalStateException;

    private native void _setOutputVideo(boolean z) throws IllegalStateException;

    private native void _setPropertyFloat(int i, float f);

    private native void _setPropertyLong(int i, long j);

    private native boolean _setRotation180(boolean z) throws IllegalStateException;

    private native void _setScale(float f) throws IllegalStateException;

    private native void _setStreamSelected(int i, boolean z);

    private native boolean _setStretchedVrMode(boolean z, boolean z2) throws IllegalStateException;

    private native void _setTexcoordRect(float f, float f2, float f3, float f4) throws IllegalStateException;

    private native void _setVideoFilter(String str, String str2, String str3, boolean z) throws IllegalStateException;

    private native void _setVideoFilterRotate(int i, boolean z) throws IllegalStateException;

    private native void _setVideoFilterRotate180(boolean z) throws IllegalStateException;

    private native void _setVideoFilterTranspose(String str, boolean z) throws IllegalStateException;

    private native void _setVideoSurface(Surface surface);

    private native boolean _setVrMode(boolean z) throws IllegalStateException;

    private native void _skipFrame(int i) throws IllegalStateException;

    private native void _skipFrameInMS(long j) throws IllegalStateException;

    private native void _start() throws IllegalStateException;

    private native void _startInsertVideo(int i, int i2, int i3) throws IllegalStateException;

    private native void _startRecordVideo(String str, String str2, int i, int i2) throws IllegalStateException, IOException, SecurityException, IllegalArgumentException;

    private native void _stop() throws IllegalStateException;

    private native void _stopInsertVideo() throws IllegalStateException;

    private native void _stopRecordVideo() throws IllegalStateException;

    private native void _stopSkipFrame() throws IllegalStateException;

    private native void _takePicture(String str, String str2, int i, int i2, int i3) throws IllegalStateException, IOException, SecurityException, IllegalArgumentException;
    ...
    public void setSurface(Surface surface) {
        if (this.mScreenOnWhilePlaying && surface != null) {
            DebugLog.m474w(TAG, "setScreenOnWhilePlaying(true) is ineffective for Surface");
        }
    ...
    */
    ...
    public void sendRtcpRrData(byte[] bArr) throws IllegalStateException {
        _sendRtcpRrData(bArr, bArr.length);
    }

    @Override // tv.danmaku.ijk.media.player.IMediaPlayer
    public void takePicture(String str, String str2, int i, int i2, int i3) throws IllegalStateException, IOException, SecurityException, IllegalArgumentException {
        _takePicture(str, str2, i, i2, i3);
    }

    @Override // tv.danmaku.ijk.media.player.IMediaPlayer
    public void startRecordVideo(String str, String str2, int i, int i2) throws IllegalStateException, IOException, SecurityException, IllegalArgumentException {
        _startRecordVideo(str, str2, i, i2);
    }
    ...
    public void prestartInsertVideo(String str, String str2, int i, int i2) throws IllegalStateException, IOException, SecurityException, IllegalArgumentException {
        _prestartInsertVideo(str, str2, i, i2);
    }

    @Override // tv.danmaku.ijk.media.player.IMediaPlayer
    public void startInsertVideo(int i, int i2, int i3) throws IllegalStateException {
        _startInsertVideo(i, i2, i3);
    }

    @Override // tv.danmaku.ijk.media.player.IMediaPlayer
    public void insertVideoData(byte[] bArr, int i, boolean z) throws IllegalStateException {
        _insertVideoData(bArr, bArr.length, i, z);
    }
    ...
    public void setOutputOriginalVideo(boolean z) throws IllegalStateException {
        _setOutputOriginalVideo(z);
    }

    @Override // tv.danmaku.ijk.media.player.IMediaPlayer
    public boolean setVrMode(boolean z) throws IllegalStateException {
        return _setVrMode(z);
    }

    public boolean setStretchedVrMode(boolean z, boolean z2) throws IllegalStateException {
        return _setStretchedVrMode(z, z2);
    }

    @Override // tv.danmaku.ijk.media.player.IMediaPlayer
    public boolean setRotation180(boolean z) throws IllegalStateException {
        setVideoFilterRotate180(z);
        return true;
    }

    @Override // tv.danmaku.ijk.media.player.IMediaPlayer
    public void setTexcoordRect(float f, float f2, float f3, float f4) throws IllegalStateException {
        _setTexcoordRect(f, f2, f3, f4);
    }

    public void setVideoFilter(String str, String str2, String str3, boolean z) throws IllegalStateException {
        _setVideoFilter(str, str2, str3, z);
    }

    public void setVideoFilterRotate(int i, boolean z) throws IllegalStateException {
        _setVideoFilterRotate(i, z);
    }

    public void setVideoFilterTranspose(String str, boolean z) throws IllegalStateException {
        _setVideoFilterTranspose(str, z);
    }

    public void setVideoFilterRotate180(boolean z) throws IllegalStateException {
        _setVideoFilterRotate180(z);
    }
    ...
    public float getScale() throws IllegalStateException {
        return _getScale();
    }
    ...
    public void setScreenOnWhilePlaying(boolean z) {
        if (this.mScreenOnWhilePlaying != z) {
            if (z && this.mSurfaceHolder == null) {
                DebugLog.m474w(TAG, "setScreenOnWhilePlaying(true) is ineffective without a SurfaceHolder");
            }
    ...
    public float getVideoDefineFramesPerSecond() {
        return _getPropertyFloat(PROP_FLOAT_VIDEO_DEFINE_FRAMES_PER_SECOND, 0.0f);
    }

    public void setVideoForceFramerate(float f) {
        _setPropertyFloat(PROP_FLOAT_VIDEO_FORCE_FRAMERATE, f);
    }
    ...
    public long getRtpSpeed() {
        return _getPropertyLong(FFP_PROP_INT64_RTP_SPEED, 0L);
    }

    public long getRtpTrafficStatisticByteCount() {
        return _getPropertyLong(FFP_PROP_INT64_RTP_TRAFFIC_STATISTIC_BYTE_COUNT, 0L);
    }

    public long getConnectedTime() {
        return _getPropertyLong(FFP_PROP_INT64_CONNECTED_TIME, 0L);
    }
    ...
    private static class EventHandler extends Handler {
        ...
        public void handleMessage(Message message) {
            ...
            if (ijkMediaPlayer != null) {
                if (ijkMediaPlayer.mNativeMediaPlayer != 0) {
                    ...
                    if (i != 0) {
                        ...
                        if (i == 100) {
                            DebugLog.m468e(IjkMediaPlayer.TAG, "Error (" + message.arg1 + "," + message.arg2 + ")");
                        ...
                        if (i == 200) {
                            if (message.arg1 == 3) {
                                DebugLog.m470i(IjkMediaPlayer.TAG, "Info: MEDIA_INFO_VIDEO_RENDERING_START\n");
                            }
                        ...
                        if (i == IjkMediaPlayer.RTCP_SR_DATA) {
                            ijkMediaPlayer.notifyOnReceivedRtcpSrData((byte[]) message.obj);
                            return;
                        }
                        if (i == IjkMediaPlayer.TAKE_PIC_STATE) {
                            ijkMediaPlayer.notifyOnTookPicture(message.arg2, (String) message.obj);
                            return;
                        }
                        switch (i) {
                            case IjkMediaPlayer.REC_VIDEO_STATE /* 80020 */:
                                ijkMediaPlayer.notifyOnRecordVideo(message.arg1, (String) message.obj);
                                break;
                            case IjkMediaPlayer.INS_VIDEO_STATE /* 80021 */:
                                ijkMediaPlayer.notifyOnInsertVideo(message.arg1);
                                break;
                            default:
                                switch (i) {
                                    case IjkMediaPlayer.OUT_VIDEO_STATE /* 80028 */:
                                        if (message.obj != null) {
                                            int i2 = message.arg1;
                                            ijkMediaPlayer.notifyOnReceivedFrame((byte[]) message.obj, (i2 & 4095) << 1, ((i2 >> 12) & 2047) << 1, (i2 >> 23) & FrameMetricsAggregator.EVERY_DURATION);
                                            break;
                                        }
                                        break;
                                    case IjkMediaPlayer.ORG_VIDEO_STATE /* 80029 */:
                                        if (message.obj != null) {
                                            int i3 = message.arg1;
                                            ijkMediaPlayer.notifyOnReceivedOriginalData((byte[]) message.obj, (i3 & 1023) << 1, ((i3 >> 10) & 1023) << 1, (i3 >> 20) & FrameMetricsAggregator.EVERY_DURATION, (i3 >> 29) & 7);
                                            break;
                                        }
                                        break;
                                    case IjkMediaPlayer.DEVICE_CONNECTED /* 80030 */:
                                        ijkMediaPlayer.notifyOnDeviceConnected();
                                        break;
                                    default:
                                        DebugLog.m468e(IjkMediaPlayer.TAG, "Unknown message type " + message.what);
                                        break;
                                }
                        }
                        return;
            ...
            DebugLog.m474w(IjkMediaPlayer.TAG, "IjkMediaPlayer went away with unhandled events");
        }
    }
