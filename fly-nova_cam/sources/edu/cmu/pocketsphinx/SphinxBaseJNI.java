...
public class SphinxBaseJNI {
    ...
    public static final native int FrontEnd_endUtt(long j, FrontEnd frontEnd, long j2);

    public static final native int FrontEnd_outputSize(long j, FrontEnd frontEnd);

    public static final native int FrontEnd_processUtt(long j, FrontEnd frontEnd, long j2, long j3, long j4);

    public static final native void FrontEnd_startUtt(long j, FrontEnd frontEnd);
    ...
    public static final native long JsgfIterator_ptr_get(long j, JsgfIterator jsgfIterator);

    public static final native void JsgfIterator_ptr_set(long j, JsgfIterator jsgfIterator, long j2);
    ...
    public static final native String Jsgf_name(long j, Jsgf jsgf);
    ...
    public static final native long NGramModelSetIterator_ptr_get(long j, NGramModelSetIterator nGramModelSetIterator);

    public static final native void NGramModelSetIterator_ptr_set(long j, NGramModelSetIterator nGramModelSetIterator, long j2);
    ...
    public static final native int NGramModel_addWord(long j, NGramModel nGramModel, String str, long j2);
    ...
    public static final native int NGramModel_prob(long j, NGramModel nGramModel, long j2, long j3);

    public static final native int NGramModel_size(long j, NGramModel nGramModel);

    public static final native long NGramModel_strToType(long j, NGramModel nGramModel, String str);

    public static final native String NGramModel_typeToStr(long j, NGramModel nGramModel, int i);

    public static final native void NGramModel_write(long j, NGramModel nGramModel, String str, long j2);
    ...
    public static final native long new_FsgModel__SWIG_1(long j);

    public static final native long new_FsgModel__SWIG_2(String str, long j, LogMath logMath, float f);
    ...
    public static final native long new_LogMath__SWIG_1(long j);
