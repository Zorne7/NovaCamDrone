...
class PathsKt__PathUtilsKt extends PathsKt__PathReadWriteKt {
    ...
    public static final Path relativeToOrNull(Path path, Path base) {
        ...
        try {
            ...
            return Trace$$ExternalSyntheticApiModelOutline0.m354m((Object) null);
        }
    }
    ...
    static /* synthetic */ Path copyTo$default(Path path, Path target, boolean z, int i, Object obj) throws IOException {
        ...
        if (z) {
            copyOptionArr = new CopyOption[]{StreamsKt$$ExternalSyntheticApiModelOutline0.m447m(StandardCopyOption.REPLACE_EXISTING)};
        } else {
    ...
    public static final List<Path> listDirectoryEntries(Path path, String glob) throws IOException {
        ...
        try {
            DirectoryStream it = Trace$$ExternalSyntheticApiModelOutline0.m349m((Object) directoryStreamNewDirectoryStream);
    ...
    private static final /* synthetic */ <V extends FileAttributeView> V fileAttributesViewOrNull(Path path, LinkOption... options) {
        ...
        return (V) Files.getFileAttributeView(path, Trace$$ExternalSyntheticApiModelOutline0.m342m(), (LinkOption[]) Arrays.copyOf(options, options.length));
    }
    ...
    private static final /* synthetic */ <V extends FileAttributeView> V fileAttributesView(Path path, LinkOption... options) {
        ...
        Intrinsics.checkNotNullParameter(options, "options");
        Intrinsics.reifiedOperationMarker(4, "V");
        FileAttributeView fileAttributeView = Files.getFileAttributeView(path, Trace$$ExternalSyntheticApiModelOutline0.m342m(), (LinkOption[]) Arrays.copyOf(options, options.length));
        if (fileAttributeView != null) {
            return (V) Trace$$ExternalSyntheticApiModelOutline0.m377m((Object) fileAttributeView);
        }
        Intrinsics.reifiedOperationMarker(4, "V");
        PathsKt.fileAttributeViewNotAvailable(path, Trace$$ExternalSyntheticApiModelOutline0.m342m());
    ...
    private static final /* synthetic */ <A extends BasicFileAttributes> A readAttributes(Path path, LinkOption... options) throws IOException {
        ...
        BasicFileAttributes attributes = Files.readAttributes(path, (Class<BasicFileAttributes>) Trace$$ExternalSyntheticApiModelOutline0.m524m$1(), (LinkOption[]) Arrays.copyOf(options, options.length));
        Intrinsics.checkNotNullExpressionValue(attributes, "readAttributes(this, A::class.java, *options)");
        return (A) Trace$$ExternalSyntheticApiModelOutline0.m375m((Object) attributes);
    }
