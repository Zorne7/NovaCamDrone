...
public class AppCompatSpinner extends Spinner implements TintableBackgroundView {
    ...
    public AppCompatSpinner(Context context, int i) {
        this(context, null, C0046R.attr.spinnerStyle, i);
    }

    public AppCompatSpinner(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, C0046R.attr.spinnerStyle);
    }
  ...
  0x0051: PHI (r11v6 android.content.res.TypedArray) = (r11v5 android.content.res.TypedArray), (r11v8 android.content.res.TypedArray) binds: [B:24:0x0062, B:15:0x004f] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    */
    public AppCompatSpinner(Context context, AttributeSet attributeSet, int i, int i2, Resources.Theme theme) throws Throwable {
        ...
        TintTypedArray tintTypedArrayObtainStyledAttributes = TintTypedArray.obtainStyledAttributes(context, attributeSet, C0046R.styleable.Spinner, i, 0);
        this.mBackgroundTintHelper = new AppCompatBackgroundHelper(this);
        if (theme != null) {
            this.mPopupContext = new ContextThemeWrapper(context, theme);
        } else {
            int resourceId = tintTypedArrayObtainStyledAttributes.getResourceId(C0046R.styleable.Spinner_popupTheme, 0);
            if (resourceId != 0) {
        ...
        try {
            if (i2 == -1) {
                ...
                try {
                    ...
                    textArray = tintTypedArrayObtainStyledAttributes.getTextArray(C0046R.styleable.Spinner_android_entries);
                    if (textArray != null) {
                    }
            ...
            if (i2 != 0) {
                ...
                dialogPopup.setPromptText(tintTypedArrayObtainStyledAttributes.getString(C0046R.styleable.Spinner_android_prompt));
            } else if (i2 == 1) {
                final DropdownPopup dropdownPopup = new DropdownPopup(this.mPopupContext, attributeSet, i);
                TintTypedArray tintTypedArrayObtainStyledAttributes2 = TintTypedArray.obtainStyledAttributes(this.mPopupContext, attributeSet, C0046R.styleable.Spinner, i, 0);
                this.mDropDownWidth = tintTypedArrayObtainStyledAttributes2.getLayoutDimension(C0046R.styleable.Spinner_android_dropDownWidth, -2);
                dropdownPopup.setBackgroundDrawable(tintTypedArrayObtainStyledAttributes2.getDrawable(C0046R.styleable.Spinner_android_popupBackground));
                dropdownPopup.setPromptText(tintTypedArrayObtainStyledAttributes.getString(C0046R.styleable.Spinner_android_prompt));
            ...
            if (textArray != null) {
                ...
                arrayAdapter.setDropDownViewResource(C0046R.layout.support_simple_spinner_dropdown_item);
