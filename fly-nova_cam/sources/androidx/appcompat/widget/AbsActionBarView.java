...
abstract class AbsActionBarView extends ViewGroup {
    ...
    AbsActionBarView(Context context, AttributeSet attributeSet, int i) {
        ...
        if (context.getTheme().resolveAttribute(C0046R.attr.actionBarPopupTheme, typedValue, true) && typedValue.resourceId != 0) {
    ...
    protected void onConfigurationChanged(Configuration configuration) {
        ...
        TypedArray typedArrayObtainStyledAttributes = getContext().obtainStyledAttributes(null, C0046R.styleable.ActionBar, C0046R.attr.actionBarStyle, 0);
        setContentHeight(typedArrayObtainStyledAttributes.getLayoutDimension(C0046R.styleable.ActionBar_height, 0));
