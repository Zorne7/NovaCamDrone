...
class TooltipPopup {
    ...
    TooltipPopup(Context context) {
        ...
        View viewInflate = LayoutInflater.from(context).inflate(C0046R.layout.abc_tooltip, (ViewGroup) null);
        this.mContentView = viewInflate;
        this.mMessageView = (TextView) viewInflate.findViewById(C0046R.id.message);
        ...
        layoutParams.windowAnimations = C0046R.style.Animation_AppCompat_Tooltip;
    ...
    private void computePosition(View view, int i, int i2, boolean z, WindowManager.LayoutParams layoutParams) throws Resources.NotFoundException {
        ...
        int dimensionPixelOffset = this.mContext.getResources().getDimensionPixelOffset(C0046R.dimen.tooltip_precise_anchor_threshold);
        if (view.getWidth() < dimensionPixelOffset) {
            i = view.getWidth() / 2;
        }
        if (view.getHeight() >= dimensionPixelOffset) {
            int dimensionPixelOffset2 = this.mContext.getResources().getDimensionPixelOffset(C0046R.dimen.tooltip_precise_anchor_extra_offset);
        ...
        int dimensionPixelOffset3 = this.mContext.getResources().getDimensionPixelOffset(z ? C0046R.dimen.tooltip_y_offset_touch : C0046R.dimen.tooltip_y_offset_non_touch);
