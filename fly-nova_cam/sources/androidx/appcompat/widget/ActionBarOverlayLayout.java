...
public class ActionBarOverlayLayout extends ViewGroup implements DecorContentParent, NestedScrollingParent, NestedScrollingParent2, NestedScrollingParent3 {
    ...
    static final int[] ATTRS = {C0046R.attr.actionBarSize, R.attr.windowContentOverlay};
    ...
    protected void onMeasure(int i, int i2) {
        ...
        if (!this.mOverlayMode && !z) {
            ...
            this.mInnerInsets = new WindowInsetsCompat.Builder(this.mInnerInsets).setSystemWindowInsets(Insets.m149of(this.mInnerInsets.getSystemWindowInsetLeft(), this.mInnerInsets.getSystemWindowInsetTop() + measuredHeight, this.mInnerInsets.getSystemWindowInsetRight(), this.mInnerInsets.getSystemWindowInsetBottom())).build();
        }
    ...
    void pullChildren() {
        if (this.mContent == null) {
            this.mContent = (ContentFrameLayout) findViewById(C0046R.id.action_bar_activity_content);
            this.mActionBarTop = (ActionBarContainer) findViewById(C0046R.id.action_bar_container);
            this.mDecorToolbar = getDecorToolbar(findViewById(C0046R.id.action_bar));
        }
    }
