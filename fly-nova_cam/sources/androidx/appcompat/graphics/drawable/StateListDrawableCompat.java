...
public class StateListDrawableCompat extends DrawableContainerCompat {
    ...
    public void inflate(Context context, Resources resources, XmlPullParser xmlPullParser, AttributeSet attributeSet, Resources.Theme theme) throws XmlPullParserException, IOException {
        TypedArray typedArrayObtainAttributes = TypedArrayUtils.obtainAttributes(resources, theme, attributeSet, C0076R.styleable.StateListDrawable);
        setVisible(typedArrayObtainAttributes.getBoolean(C0076R.styleable.StateListDrawable_android_visible, true), true);
    ...
    private void updateStateFromTypedArray(TypedArray typedArray) {
        ...
        stateListState.mVariablePadding = typedArray.getBoolean(C0076R.styleable.StateListDrawable_android_variablePadding, stateListState.mVariablePadding);
        stateListState.mConstantSize = typedArray.getBoolean(C0076R.styleable.StateListDrawable_android_constantSize, stateListState.mConstantSize);
        stateListState.mEnterFadeDuration = typedArray.getInt(C0076R.styleable.StateListDrawable_android_enterFadeDuration, stateListState.mEnterFadeDuration);
        stateListState.mExitFadeDuration = typedArray.getInt(C0076R.styleable.StateListDrawable_android_exitFadeDuration, stateListState.mExitFadeDuration);
        stateListState.mDither = typedArray.getBoolean(C0076R.styleable.StateListDrawable_android_dither, stateListState.mDither);
    }
    ...
    private void inflateChildElements(Context context, Resources resources, XmlPullParser xmlPullParser, AttributeSet attributeSet, Resources.Theme theme) throws XmlPullParserException, IOException {
        ...
        while (true) {
            ...
            if (next2 == 2 && depth2 <= depth && xmlPullParser.getName().equals("item")) {
                TypedArray typedArrayObtainAttributes = TypedArrayUtils.obtainAttributes(resources, theme, attributeSet, C0076R.styleable.StateListDrawableItem);
                int resourceId = typedArrayObtainAttributes.getResourceId(C0076R.styleable.StateListDrawableItem_android_drawable, -1);
