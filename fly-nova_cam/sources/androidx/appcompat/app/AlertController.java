...
class AlertController {
    ...
    private static boolean shouldCenterSingleButton(Context context) {
        ...
        context.getTheme().resolveAttribute(C0046R.attr.alertDialogCenterButtons, typedValue, true);
    ...
    public AlertController(Context context, AppCompatDialog appCompatDialog, Window window) {
        ...
        TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(null, C0046R.styleable.AlertDialog, C0046R.attr.alertDialogStyle, 0);
        this.mAlertDialogLayout = typedArrayObtainStyledAttributes.getResourceId(C0046R.styleable.AlertDialog_android_layout, 0);
        this.mButtonPanelSideLayout = typedArrayObtainStyledAttributes.getResourceId(C0046R.styleable.AlertDialog_buttonPanelSideLayout, 0);
        this.mListLayout = typedArrayObtainStyledAttributes.getResourceId(C0046R.styleable.AlertDialog_listLayout, 0);
        this.mMultiChoiceItemLayout = typedArrayObtainStyledAttributes.getResourceId(C0046R.styleable.AlertDialog_multiChoiceItemLayout, 0);
        this.mSingleChoiceItemLayout = typedArrayObtainStyledAttributes.getResourceId(C0046R.styleable.AlertDialog_singleChoiceItemLayout, 0);
        this.mListItemLayout = typedArrayObtainStyledAttributes.getResourceId(C0046R.styleable.AlertDialog_listItemLayout, 0);
        this.mShowTitle = typedArrayObtainStyledAttributes.getBoolean(C0046R.styleable.AlertDialog_showTitle, true);
        this.mButtonIconDimen = typedArrayObtainStyledAttributes.getDimensionPixelSize(C0046R.styleable.AlertDialog_buttonIconDimen, 0);
    ...
    private void setupView() {
        ...
        View viewFindViewById3 = this.mWindow.findViewById(C0046R.id.parentPanel);
        View viewFindViewById4 = viewFindViewById3.findViewById(C0046R.id.topPanel);
        View viewFindViewById5 = viewFindViewById3.findViewById(C0046R.id.contentPanel);
        View viewFindViewById6 = viewFindViewById3.findViewById(C0046R.id.buttonPanel);
        ViewGroup viewGroup = (ViewGroup) viewFindViewById3.findViewById(C0046R.id.customPanel);
        setupCustomContent(viewGroup);
        View viewFindViewById7 = viewGroup.findViewById(C0046R.id.topPanel);
        View viewFindViewById8 = viewGroup.findViewById(C0046R.id.contentPanel);
        View viewFindViewById9 = viewGroup.findViewById(C0046R.id.buttonPanel);
        ...
        if (!z3 && viewGroupResolvePanel2 != null && (viewFindViewById2 = viewGroupResolvePanel2.findViewById(C0046R.id.textSpacerNoButtons)) != null) {
        ...
        if (z2 != 0) {
            ...
            View viewFindViewById10 = (this.mMessage == null && this.mListView == null) ? null : viewGroupResolvePanel.findViewById(C0046R.id.titleDividerNoCustom);
            if (viewFindViewById10 != null) {
                viewFindViewById10.setVisibility(0);
            }
        } else if (viewGroupResolvePanel2 != null && (viewFindViewById = viewGroupResolvePanel2.findViewById(C0046R.id.textSpacerNoTitle)) != null) {
    ...
    private void setScrollIndicators(ViewGroup viewGroup, View view, int i, int i2) {
        View viewFindViewById = this.mWindow.findViewById(C0046R.id.scrollIndicatorUp);
        View viewFindViewById2 = this.mWindow.findViewById(C0046R.id.scrollIndicatorDown);
    ...
    class C00492 implements NestedScrollView.OnScrollChangeListener {
        final /* synthetic */ View val$bottom;
        final /* synthetic */ View val$top;

        C00492(View view, View view2) {
            this.val$top = view;
    ...
    class RunnableC00503 implements Runnable {
        ...
        RunnableC00503(View view, View view2) {
            this.val$top = view;
            this.val$bottom = view2;
        }
    ...
    class C00514 implements AbsListView.OnScrollListener {
        final /* synthetic */ View val$bottom;
        final /* synthetic */ View val$top;
    ...
    class RunnableC00525 implements Runnable {
        final /* synthetic */ View val$bottom;
        final /* synthetic */ View val$top;

        RunnableC00525(View view, View view2) {
            this.val$top = view;
            this.val$bottom = view2;
        }
    ...
    private void setupCustomContent(ViewGroup viewGroup) {
        ...
        if (z) {
            FrameLayout frameLayout = (FrameLayout) this.mWindow.findViewById(C0046R.id.custom);
    ...
    private void setupTitle(ViewGroup viewGroup) {
        if (this.mCustomTitleView != null) {
            ...
            this.mWindow.findViewById(C0046R.id.title_template).setVisibility(8);
            return;
        }
        this.mIconView = (ImageView) this.mWindow.findViewById(R.id.icon);
        if ((!TextUtils.isEmpty(this.mTitle)) && this.mShowTitle) {
            TextView textView = (TextView) this.mWindow.findViewById(C0046R.id.alertTitle);
    ...
    private void setupContent(ViewGroup viewGroup) {
        NestedScrollView nestedScrollView = (NestedScrollView) this.mWindow.findViewById(C0046R.id.scrollView);
    ...
    public static class RecycleListView extends ListView {
        ...
        public RecycleListView(Context context, AttributeSet attributeSet) {
            ...
            TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0046R.styleable.RecycleListView);
            this.mPaddingBottomNoButtons = typedArrayObtainStyledAttributes.getDimensionPixelOffset(C0046R.styleable.RecycleListView_paddingBottomNoButtons, -1);
            this.mPaddingTopNoTitle = typedArrayObtainStyledAttributes.getDimensionPixelOffset(C0046R.styleable.RecycleListView_paddingTopNoTitle, -1);
        }
