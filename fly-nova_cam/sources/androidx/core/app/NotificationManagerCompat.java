...
public final class NotificationManagerCompat {
    ...
    public void deleteUnlistedNotificationChannels(Collection<String> collection) {
        if (Build.VERSION.SDK_INT >= 26) {
            ...
            while (it.hasNext()) {
                NotificationChannel notificationChannelM17m = ComponentDialog$$ExternalSyntheticApiModelOutline0.m17m(it.next());
                if (!collection.contains(notificationChannelM17m.getId()) && (Build.VERSION.SDK_INT < 30 || !collection.contains(notificationChannelM17m.getParentChannelId()))) {
                    this.mNotificationManager.deleteNotificationChannel(notificationChannelM17m.getId());
                }
            }
        }
    }
    ...
    public NotificationChannelGroup getNotificationChannelGroup(String str) {
        ...
        if (Build.VERSION.SDK_INT >= 26) {
            ...
            while (it.hasNext()) {
                NotificationChannelGroup notificationChannelGroupM103m = NotificationCompat$Style$$ExternalSyntheticApiModelOutline0.m103m((Object) it.next());
                if (notificationChannelGroupM103m.getId().equals(str)) {
                    return notificationChannelGroupM103m;
                }
            }
        }
        return null;
    ...
    public List<NotificationChannelCompat> getNotificationChannelsCompat() {
        if (Build.VERSION.SDK_INT >= 26) {
            ...
            if (!notificationChannels.isEmpty()) {
                ...
                while (it.hasNext()) {
                    arrayList.add(new NotificationChannelCompat(ComponentDialog$$ExternalSyntheticApiModelOutline0.m17m((Object) it.next())));
                }
                return arrayList;
            }
        }
        ...
        if (Build.VERSION.SDK_INT >= 26) {
            ...
            if (!notificationChannelGroups.isEmpty()) {
                ...
                while (it.hasNext()) {
                    NotificationChannelGroup notificationChannelGroupM103m = NotificationCompat$Style$$ExternalSyntheticApiModelOutline0.m103m((Object) it.next());
                    if (Build.VERSION.SDK_INT >= 28) {
                        arrayList.add(new NotificationChannelGroupCompat(notificationChannelGroupM103m));
                    } else {
                        arrayList.add(new NotificationChannelGroupCompat(notificationChannelGroupM103m, notificationChannels));
                    }
                }
                return arrayList;
            }
