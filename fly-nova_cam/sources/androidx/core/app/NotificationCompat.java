...
public class NotificationCompat {
    ...
    public static class Builder {
        ...
        public Builder(Context context, Notification notification) {
            ...
            if (Build.VERSION.SDK_INT >= 28 && (parcelableArrayList = notification.extras.getParcelableArrayList(NotificationCompat.EXTRA_PEOPLE_LIST)) != null && !parcelableArrayList.isEmpty()) {
                ...
                while (it2.hasNext()) {
                    addPerson(Person.fromAndroidPerson(ComponentDialog$$ExternalSyntheticApiModelOutline0.m20m(it2.next())));
                }
            }
        ...
        private Bitmap reduceLargeIconSize(Bitmap bitmap) throws Resources.NotFoundException {
            ...
            int dimensionPixelSize = resources.getDimensionPixelSize(C0148R.dimen.compat_notification_large_icon_max_width);
            int dimensionPixelSize2 = resources.getDimensionPixelSize(C0148R.dimen.compat_notification_large_icon_max_height);
    ...
    public static abstract class Style {
        ...
        private static Style constructCompatStyleByPlatformName(String str) {
            ...
            if (Build.VERSION.SDK_INT >= 24) {
                if (str.equals(NotificationCompat$Style$$ExternalSyntheticApiModelOutline0.m126m().getName())) {
                    return new MessagingStyle();
                }
                if (str.equals(NotificationCompat$Style$$ExternalSyntheticApiModelOutline0.m$1().getName())) {
        ...
        */
        public RemoteViews applyStandardTemplate(boolean z, int i, boolean z2) throws Resources.NotFoundException {
            ...
            if (this.mBuilder.mLargeIcon != null) {
                remoteViews.setViewVisibility(C0148R.id.icon, 0);
                remoteViews.setImageViewBitmap(C0148R.id.icon, this.mBuilder.mLargeIcon);
                if (z && this.mBuilder.mNotification.icon != 0) {
                    int dimensionPixelSize = resources.getDimensionPixelSize(C0148R.dimen.notification_right_icon_size);
                    remoteViews.setImageViewBitmap(C0148R.id.right_icon, createIconWithBackground(this.mBuilder.mNotification.icon, dimensionPixelSize, dimensionPixelSize - (resources.getDimensionPixelSize(C0148R.dimen.notification_small_icon_background_padding) * 2), this.mBuilder.getColor()));
                    remoteViews.setViewVisibility(C0148R.id.right_icon, 0);
                }
            } else if (z && this.mBuilder.mNotification.icon != 0) {
                remoteViews.setViewVisibility(C0148R.id.icon, 0);
                remoteViews.setImageViewBitmap(C0148R.id.icon, createIconWithBackground(this.mBuilder.mNotification.icon, resources.getDimensionPixelSize(C0148R.dimen.notification_large_icon_width) - resources.getDimensionPixelSize(C0148R.dimen.notification_big_circle_margin), resources.getDimensionPixelSize(C0148R.dimen.notification_small_icon_size_as_large), this.mBuilder.getColor()));
            }
            if (this.mBuilder.mContentTitle != null) {
                remoteViews.setTextViewText(C0148R.id.title, this.mBuilder.mContentTitle);
            }
            boolean z5 = true;
            if (this.mBuilder.mContentText != null) {
                remoteViews.setTextViewText(C0148R.id.text, this.mBuilder.mContentText);
                z3 = true;
            } else {
                z3 = false;
            }
            if (this.mBuilder.mContentInfo != null) {
                remoteViews.setTextViewText(C0148R.id.info, this.mBuilder.mContentInfo);
                remoteViews.setViewVisibility(C0148R.id.info, 0);
            } else if (this.mBuilder.mNumber > 0) {
                if (this.mBuilder.mNumber > resources.getInteger(C0148R.integer.status_bar_notification_info_maxnum)) {
                    remoteViews.setTextViewText(C0148R.id.info, resources.getString(C0148R.string.status_bar_notification_info_overflow));
                } else {
                    remoteViews.setTextViewText(C0148R.id.info, NumberFormat.getIntegerInstance().format(this.mBuilder.mNumber));
                }
                remoteViews.setViewVisibility(C0148R.id.info, 0);
            } else {
                remoteViews.setViewVisibility(C0148R.id.info, 8);
                z4 = false;
                if (this.mBuilder.mSubText != null) {
                    remoteViews.setTextViewText(C0148R.id.text, this.mBuilder.mSubText);
                    if (this.mBuilder.mContentText != null) {
                        remoteViews.setTextViewText(C0148R.id.text2, this.mBuilder.mContentText);
                        remoteViews.setViewVisibility(C0148R.id.text2, 0);
                        if (z2) {
                            remoteViews.setTextViewTextSize(C0148R.id.text, 0, resources.getDimensionPixelSize(C0148R.dimen.notification_subtext_size));
                        }
                        remoteViews.setViewPadding(C0148R.id.line1, 0, 0, 0, 0);
                    } else {
                        remoteViews.setViewVisibility(C0148R.id.text2, 8);
                    }
                }
                if (this.mBuilder.getWhenIfShowing() != 0) {
                    z5 = z4;
                } else if (this.mBuilder.mUseChronometer) {
                    remoteViews.setViewVisibility(C0148R.id.chronometer, 0);
                    remoteViews.setLong(C0148R.id.chronometer, "setBase", this.mBuilder.getWhenIfShowing() + (SystemClock.elapsedRealtime() - System.currentTimeMillis()));
                    remoteViews.setBoolean(C0148R.id.chronometer, "setStarted", true);
                    if (this.mBuilder.mChronometerCountDown && Build.VERSION.SDK_INT >= 24) {
                        remoteViews.setChronometerCountDown(C0148R.id.chronometer, this.mBuilder.mChronometerCountDown);
                    }
                } else {
                    remoteViews.setViewVisibility(C0148R.id.time, 0);
                    remoteViews.setLong(C0148R.id.time, "setTime", this.mBuilder.getWhenIfShowing());
                }
                remoteViews.setViewVisibility(C0148R.id.right_side, !z5 ? 0 : 8);
                remoteViews.setViewVisibility(C0148R.id.line3, z3 ? 0 : 8);
                return remoteViews;
            }
            z3 = true;
            z4 = true;
        ...
        private Bitmap createIconWithBackground(int i, int i2, int i3, int i4) {
            int i5 = C0148R.drawable.notification_icon_background;
            if (i4 == 0) {
                i4 = 0;
            }
        ...
        public void buildIntoRemoteViews(RemoteViews remoteViews, RemoteViews remoteViews2) {
            ...
            remoteViews.removeAllViews(C0148R.id.notification_main_column);
            remoteViews.addView(C0148R.id.notification_main_column, remoteViews2.clone());
            remoteViews.setViewVisibility(C0148R.id.notification_main_column, 0);
            remoteViews.setViewPadding(C0148R.id.notification_main_column_container, 0, calculateTopPadding(), 0, 0);
        }

        private void hideNormalContent(RemoteViews remoteViews) {
            remoteViews.setViewVisibility(C0148R.id.title, 8);
            remoteViews.setViewVisibility(C0148R.id.text2, 8);
            remoteViews.setViewVisibility(C0148R.id.text, 8);
        }

        private int calculateTopPadding() throws Resources.NotFoundException {
            Resources resources = this.mBuilder.mContext.getResources();
            int dimensionPixelSize = resources.getDimensionPixelSize(C0148R.dimen.notification_top_pad);
            int dimensionPixelSize2 = resources.getDimensionPixelSize(C0148R.dimen.notification_top_pad_large_text);
    ...
    public static class MessagingStyle extends Style {
        ...
        public void apply(NotificationBuilderWithBuilderAccessor notificationBuilderWithBuilderAccessor) {
            CharSequence text;
            Notification.MessagingStyle messagingStyleM16m;
            setGroupConversation(isGroupConversation());
            if (Build.VERSION.SDK_INT >= 24) {
                if (Build.VERSION.SDK_INT >= 28) {
                    NotificationCompat$Style$$ExternalSyntheticApiModelOutline0.m131m();
                    messagingStyleM16m = ComponentDialog$$ExternalSyntheticApiModelOutline0.m15m(this.mUser.toAndroidPerson());
                } else {
                    NotificationCompat$Style$$ExternalSyntheticApiModelOutline0.m131m();
                    messagingStyleM16m = ComponentDialog$$ExternalSyntheticApiModelOutline0.m16m(this.mUser.getName());
                }
                Iterator<Message> it = this.mMessages.iterator();
                while (it.hasNext()) {
                    messagingStyleM16m.addMessage(it.next().toAndroidMessage());
                }
                if (Build.VERSION.SDK_INT >= 26) {
                    Iterator<Message> it2 = this.mHistoricMessages.iterator();
                    while (it2.hasNext()) {
                        messagingStyleM16m.addHistoricMessage(it2.next().toAndroidMessage());
                    }
                }
                if (this.mIsGroupConversation.booleanValue() || Build.VERSION.SDK_INT >= 28) {
                    messagingStyleM16m.setConversationTitle(this.mConversationTitle);
                }
                if (Build.VERSION.SDK_INT >= 28) {
                    messagingStyleM16m.setGroupConversation(this.mIsGroupConversation.booleanValue());
                }
                messagingStyleM16m.setBuilder(notificationBuilderWithBuilderAccessor.getBuilder());
                return;
            }
        ...
        public static final class Message {
                ...
                try {
                    if (bundle.containsKey(KEY_TEXT) && bundle.containsKey(KEY_TIMESTAMP)) {
                        if (bundle.containsKey(KEY_PERSON)) {
                            ...
                            personBuild = Person.fromAndroidPerson(ComponentDialog$$ExternalSyntheticApiModelOutline0.m20m((Object) bundle.getParcelable(KEY_NOTIFICATION_PERSON)));
                        } else {
            ...
            Notification.MessagingStyle.Message toAndroidMessage() {
                Notification.MessagingStyle.Message messageM99m;
                Person person = getPerson();
                if (Build.VERSION.SDK_INT >= 28) {
                    NotificationCompat$Style$$ExternalSyntheticApiModelOutline0.m492m$1();
                    messageM99m = NotificationCompat$Style$$ExternalSyntheticApiModelOutline0.m98m(getText(), getTimestamp(), person != null ? person.toAndroidPerson() : null);
                } else {
                    NotificationCompat$Style$$ExternalSyntheticApiModelOutline0.m492m$1();
                    messageM99m = NotificationCompat$Style$$ExternalSyntheticApiModelOutline0.m99m(getText(), getTimestamp(), person != null ? person.getName() : null);
                }
                if (getDataMimeType() != null) {
                    messageM99m.setData(getDataMimeType(), getDataUri());
                }
                return messageM99m;
            }
        }
    ...
    public static class DecoratedCustomViewStyle extends Style {
        ...
        public void apply(NotificationBuilderWithBuilderAccessor notificationBuilderWithBuilderAccessor) {
            if (Build.VERSION.SDK_INT >= 24) {
                notificationBuilderWithBuilderAccessor.getBuilder().setStyle(ComponentDialog$$ExternalSyntheticApiModelOutline0.m11m());
            }
        }
        ...
        private RemoteViews createRemoteViews(RemoteViews remoteViews, boolean z) {
            int iMin;
            int i = 0;
            RemoteViews remoteViewsApplyStandardTemplate = applyStandardTemplate(true, C0148R.layout.notification_template_custom_big, false);
            remoteViewsApplyStandardTemplate.removeAllViews(C0148R.id.actions);
            ...
            if (!z || nonContextualActions == null || (iMin = Math.min(nonContextualActions.size(), 3)) <= 0) {
                ...
                for (int i2 = 0; i2 < iMin; i2++) {
                    remoteViewsApplyStandardTemplate.addView(C0148R.id.actions, generateActionButton(nonContextualActions.get(i2)));
                }
            }
            remoteViewsApplyStandardTemplate.setViewVisibility(C0148R.id.actions, i);
            remoteViewsApplyStandardTemplate.setViewVisibility(C0148R.id.action_divider, i);
        ...
        private RemoteViews generateActionButton(Action action) {
            ...
            if (z) {
                i = C0148R.layout.notification_action_tombstone;
            } else {
                i = C0148R.layout.notification_action;
            }
            RemoteViews remoteViews = new RemoteViews(packageName, i);
            IconCompat iconCompat = action.getIconCompat();
            if (iconCompat != null) {
                remoteViews.setImageViewBitmap(C0148R.id.action_image, createColoredBitmap(iconCompat, this.mBuilder.mContext.getResources().getColor(C0148R.color.notification_action_color_filter)));
            }
            remoteViews.setTextViewText(C0148R.id.action_text, action.title);
            if (!z) {
                remoteViews.setOnClickPendingIntent(C0148R.id.action_container, action.actionIntent);
            }
            remoteViews.setContentDescription(C0148R.id.action_container, action.title);
            return remoteViews;
        }
    }
    ...
    public static class Action {
        ...
        public static final class WearableExtender implements Extender {
            ...
            public WearableExtender m499clone() {
    ...
    public static final class WearableExtender implements Extender {
        ...
        /* renamed from: clone, reason: merged with bridge method [inline-methods] */
        public WearableExtender m500clone() {
            WearableExtender wearableExtender = new WearableExtender();
    ...
    public static List<Person> getPeople(Notification notification) {
        ...
        if (Build.VERSION.SDK_INT >= 28) {
            ...
            if (parcelableArrayList != null && !parcelableArrayList.isEmpty()) {
                ...
                while (it.hasNext()) {
                    arrayList.add(Person.fromAndroidPerson(ComponentDialog$$ExternalSyntheticApiModelOutline0.m20m(it.next())));
                }
            }
        } else {
