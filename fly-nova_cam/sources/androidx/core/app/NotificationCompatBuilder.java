...
class NotificationCompatBuilder implements NotificationBuilderWithBuilderAccessor {
    ...
    NotificationCompatBuilder(NotificationCompat.Builder builder) {
        ...
        if (Build.VERSION.SDK_INT >= 26) {
            NotificationCompat$Style$$ExternalSyntheticApiModelOutline0.m496m$2();
            this.mBuilder = NotificationCompat$Style$$ExternalSyntheticApiModelOutline0.m96m(builder.mContext, builder.mChannelId);
        } else {
