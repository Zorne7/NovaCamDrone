...
public class NotificationChannelCompat {
    ...
    NotificationChannel getNotificationChannel() {
        ...
        ComponentDialog$$ExternalSyntheticApiModelOutline0.m45m();
        NotificationChannel notificationChannelM18m = ComponentDialog$$ExternalSyntheticApiModelOutline0.m18m(this.mId, this.mName, this.mImportance);
        notificationChannelM18m.setDescription(this.mDescription);
        notificationChannelM18m.setGroup(this.mGroupId);
        notificationChannelM18m.setShowBadge(this.mShowBadge);
        notificationChannelM18m.setSound(this.mSound, this.mAudioAttributes);
        notificationChannelM18m.enableLights(this.mLights);
        notificationChannelM18m.setLightColor(this.mLightColor);
        notificationChannelM18m.setVibrationPattern(this.mVibrationPattern);
        notificationChannelM18m.enableVibration(this.mVibrationEnabled);
        if (Build.VERSION.SDK_INT >= 30 && (str = this.mParentId) != null && (str2 = this.mConversationId) != null) {
            notificationChannelM18m.setConversationId(str, str2);
        }
        return notificationChannelM18m;
    }
