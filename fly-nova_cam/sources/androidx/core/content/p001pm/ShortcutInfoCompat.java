...
public class ShortcutInfoCompat {
    ...
    public ShortcutInfo toShortcutInfo() {
        ...
        ShortcutInfo.Builder intents = NotificationCompat$Style$$ExternalSyntheticApiModelOutline0.m107m(this.mContext, this.mId).setShortLabel(this.mLabel).setIntents(this.mIntents);
    ...
    static List<ShortcutInfoCompat> fromShortcuts(Context context, List<ShortcutInfo> list) {
        ...
        while (it.hasNext()) {
            arrayList.add(new Builder(context, NotificationCompat$Style$$ExternalSyntheticApiModelOutline0.m119m((Object) it.next())).build());
        }
        return arrayList;
    }
