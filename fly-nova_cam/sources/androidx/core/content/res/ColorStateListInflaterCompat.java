    ...
    private static ColorStateList inflate(Resources resources, XmlPullParser xmlPullParser, AttributeSet attributeSet, Resources.Theme theme) throws XmlPullParserException, IOException {
        ...
        while (true) {
            ...
            if (next == 2 && depth <= depth2 && xmlPullParser.getName().equals("item")) {
                TypedArray typedArrayObtainAttributes = obtainAttributes(resources2, theme, attributeSet, C0148R.styleable.ColorStateListItem);
                int resourceId = typedArrayObtainAttributes.getResourceId(C0148R.styleable.ColorStateListItem_android_color, -1);
                if (resourceId != -1 && !isColorInt(resources2, resourceId)) {
                    try {
                        ...
                        color = typedArrayObtainAttributes.getColor(C0148R.styleable.ColorStateListItem_android_color, -65281);
                    }
                } else {
                    color = typedArrayObtainAttributes.getColor(C0148R.styleable.ColorStateListItem_android_color, -65281);
                }
                float f2 = 1.0f;
                if (typedArrayObtainAttributes.hasValue(C0148R.styleable.ColorStateListItem_android_alpha)) {
                    f2 = typedArrayObtainAttributes.getFloat(C0148R.styleable.ColorStateListItem_android_alpha, 1.0f);
                } else if (typedArrayObtainAttributes.hasValue(C0148R.styleable.ColorStateListItem_alpha)) {
                    f2 = typedArrayObtainAttributes.getFloat(C0148R.styleable.ColorStateListItem_alpha, 1.0f);
                }
                if (Build.VERSION.SDK_INT >= 31 && typedArrayObtainAttributes.hasValue(C0148R.styleable.ColorStateListItem_android_lStar)) {
                    f = typedArrayObtainAttributes.getFloat(C0148R.styleable.ColorStateListItem_android_lStar, -1.0f);
                } else {
                    f = typedArrayObtainAttributes.getFloat(C0148R.styleable.ColorStateListItem_lStar, -1.0f);
                }
                ...
                for (int i4 = 0; i4 < attributeCount; i4++) {
                    ...
                    if (attributeNameResource != 16843173 && attributeNameResource != 16843551 && attributeNameResource != C0148R.attr.alpha && attributeNameResource != C0148R.attr.lStar) {
                        int i5 = i3 + 1;
