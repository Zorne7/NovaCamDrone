...
public final class MailTo {
    ...
    /* renamed from: CC */
    private static final String f22CC = "cc";
    private static final String MAILTO = "mailto";
    public static final String MAILTO_SCHEME = "mailto:";
    private static final String SUBJECT = "subject";

    /* renamed from: TO */
    private static final String f23TO = "to";
    ...
    public static MailTo parse(String str) throws ParseException {
        ...
        mailTo.mHeaders.put(f23TO, strDecode);
        return mailTo;
    }
    ...
    public String getTo() {
        return this.mHeaders.get(f23TO);
    }

    public String getCc() {
        return this.mHeaders.get(f22CC);
    }
