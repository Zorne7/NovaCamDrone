...
public final class WindowInsetsAnimationCompat {
    ...
    private static class Impl21 extends Impl {
        ...
        static void setCallback(View view, Callback callback) {
            Object tag = view.getTag(C0148R.id.tag_on_apply_window_listener);
            if (callback == null) {
                view.setTag(C0148R.id.tag_window_insets_animation_callback, null);
                if (tag == null) {
            ...
            view.setTag(C0148R.id.tag_window_insets_animation_callback, onApplyWindowInsetsListenerCreateProxyListener);
            if (tag == null) {
    ...
    private static class Impl30 extends Impl {
        ...
        Impl30(int i, Interpolator interpolator, long j) {
            this(ViewCompat$$ExternalSyntheticApiModelOutline0.m284m(i, interpolator, j));
        }
        ...
        private static class ProxyCallback extends WindowInsetsAnimation$Callback {
            ...
            public WindowInsets onProgress(WindowInsets windowInsets, List<WindowInsetsAnimation> list) {
                ...
                for (int size = list.size() - 1; size >= 0; size--) {
                    WindowInsetsAnimation windowInsetsAnimationM285m = ViewCompat$$ExternalSyntheticApiModelOutline0.m285m((Object) list.get(size));
                    WindowInsetsAnimationCompat windowInsetsAnimationCompat = getWindowInsetsAnimationCompat(windowInsetsAnimationM285m);
                    windowInsetsAnimationCompat.setFraction(windowInsetsAnimationM285m.getFraction());
        ...
        public static WindowInsetsAnimation.Bounds createPlatformBounds(BoundsCompat boundsCompat) {
            ViewCompat$$ExternalSyntheticApiModelOutline0.m294m();
            return ViewCompat$$ExternalSyntheticApiModelOutline0.m283m(boundsCompat.getLowerBound().toPlatformInsets(), boundsCompat.getUpperBound().toPlatformInsets());
        }
