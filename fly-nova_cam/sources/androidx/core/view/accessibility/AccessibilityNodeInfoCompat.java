...
public class AccessibilityNodeInfoCompat {
            ...
            if (cls != null) {
                try {
                    ...
                    try {
                        ...
                        Log.e(TAG, "Failed to execute command with argument class ViewCommandArgument: " + (cls2 == null ? ImageLoader.DEFAULT_PATH : cls2.getName()), e);
    ...
    public static final class TouchDelegateInfoCompat {
        ...
        public TouchDelegateInfoCompat(Map<Region, View> map) {
            if (Build.VERSION.SDK_INT >= 29) {
                this.mInfo = Trace$$ExternalSyntheticApiModelOutline0.m336m((Map) map);
            } else {
                this.mInfo = null;
            }
        }
    ...
    public void addSpansToExtras(CharSequence charSequence, View view) {
        if (Build.VERSION.SDK_INT < 26) {
            ...
            getExtras().putInt(SPANS_ACTION_ID_KEY, C0148R.id.accessibility_action_clickable_span);
    ...
    private SparseArray<WeakReference<ClickableSpan>> getOrCreateSpansFromViewTags(View view) {
        ...
        view.setTag(C0148R.id.tag_accessibility_clickable_spans, sparseArray);
        return sparseArray;
    }

    private SparseArray<WeakReference<ClickableSpan>> getSpansFromViewTags(View view) {
        return (SparseArray) view.getTag(C0148R.id.tag_accessibility_clickable_spans);
    }
