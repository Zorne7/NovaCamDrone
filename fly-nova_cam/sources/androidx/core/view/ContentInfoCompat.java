...
public final class ContentInfoCompat {
    ...
    public ContentInfo toContentInfo() {
        return HalfKt$$ExternalSyntheticApiModelOutline0.m226m(Objects.requireNonNull(this.mCompat.getWrapped()));
    }
    ...
    private static final class Compat31Impl implements Compat {
        ...
        Compat31Impl(ContentInfo contentInfo) {
            this.mWrapped = HalfKt$$ExternalSyntheticApiModelOutline0.m226m(Preconditions.checkNotNull(contentInfo));
        }
    ...
    private static final class BuilderCompat31Impl implements BuilderCompat {
        ...
        BuilderCompat31Impl(ClipData clipData, int i) {
            this.mPlatformBuilder = HalfKt$$ExternalSyntheticApiModelOutline0.m219m(clipData, i);
        }

        BuilderCompat31Impl(ContentInfoCompat contentInfoCompat) {
            HalfKt$$ExternalSyntheticApiModelOutline0.m239m();
            this.mPlatformBuilder = HalfKt$$ExternalSyntheticApiModelOutline0.m224m(contentInfoCompat.toContentInfo());
        }
