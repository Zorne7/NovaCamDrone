...
public class ComponentDialog extends Dialog implements LifecycleOwner, OnBackPressedDispatcherOwner {
    ...
    public ComponentDialog(Context context, int i) {
        ...
        this.onBackPressedDispatcher = new OnBackPressedDispatcher(new Runnable() { // from class: androidx.activity.ComponentDialog$$ExternalSyntheticLambda1
            ...
            public final void run() {
                ComponentDialog.m478onBackPressedDispatcher$lambda1(this.f$0);
            }
        });
    }
    ...
    public static final void m478onBackPressedDispatcher$lambda1(ComponentDialog this$0) {
