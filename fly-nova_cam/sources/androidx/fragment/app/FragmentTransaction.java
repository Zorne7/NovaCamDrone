...
public abstract class FragmentTransaction {
    ...
    static final class C0324Op {
        ...
        C0324Op(int i, Fragment fragment) {
            this.mCmd = i;
        ...
        C0324Op(int i, Fragment fragment, Lifecycle.State state) {
            this.mCmd = i;
            this.mFragment = fragment;
    ...
    void addOp(C0324Op c0324Op) {
        this.mOps.add(c0324Op);
        c0324Op.mEnterAnim = this.mEnterAnim;
        c0324Op.mExitAnim = this.mExitAnim;
        c0324Op.mPopEnterAnim = this.mPopEnterAnim;
        c0324Op.mPopExitAnim = this.mPopExitAnim;
    }
    ...
    public FragmentTransaction remove(Fragment fragment) {
        addOp(new C0324Op(3, fragment));
        return this;
    }

    public FragmentTransaction hide(Fragment fragment) {
        addOp(new C0324Op(4, fragment));
        return this;
    }

    public FragmentTransaction show(Fragment fragment) {
        addOp(new C0324Op(5, fragment));
        return this;
    }

    public FragmentTransaction detach(Fragment fragment) {
        addOp(new C0324Op(6, fragment));
        return this;
    }

    public FragmentTransaction attach(Fragment fragment) {
        addOp(new C0324Op(7, fragment));
        return this;
    }

    public FragmentTransaction setPrimaryNavigationFragment(Fragment fragment) {
        addOp(new C0324Op(8, fragment));
        return this;
    }

    public FragmentTransaction setMaxLifecycle(Fragment fragment, Lifecycle.State state) {
        addOp(new C0324Op(10, fragment, state));
        return this;
    }
