...
public final class FragmentContainerView extends FrameLayout {
    ...
    public FragmentContainerView(Context context, AttributeSet attributeSet, int i) {
        ...
        if (attributeSet != null) {
            ...
            TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0273R.styleable.FragmentContainerView);
            if (classAttribute != null) {
                str = "class";
            } else {
                classAttribute = typedArrayObtainStyledAttributes.getString(C0273R.styleable.FragmentContainerView_android_name);
                str = "android:name";
            }
    ...
    FragmentContainerView(Context context, AttributeSet attributeSet, FragmentManager fragmentManager) {
        ...
        String classAttribute = attributeSet.getClassAttribute();
        TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0273R.styleable.FragmentContainerView);
        classAttribute = classAttribute == null ? typedArrayObtainStyledAttributes.getString(C0273R.styleable.FragmentContainerView_android_name) : classAttribute;
        String string = typedArrayObtainStyledAttributes.getString(C0273R.styleable.FragmentContainerView_android_tag);
        typedArrayObtainStyledAttributes.recycle();
        int id = getId();
